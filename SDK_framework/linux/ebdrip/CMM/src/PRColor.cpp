	...
	di_tlimitinfo_t  *tlimit)
{
	...
	/*
	 * OBJ_IMAG_{COLOR, MONO}çª¶å ™ï¿½	 * GRAYï¾†åœï¿½ï¿½ï½½[ï¾†æª€çª¶å ™å¨¯ï¿½ï¾‚ï½»çª¶å‡–ï½¨ï¾‹ï¿½é—‡ï¿½çª¶å ™ï¿½ï¿½ï¾ƒå¼˜BJ_IMAGçª¶å ™ä¿„ï¿½uçª¶å ‹ï½«ï¾…ï¿½ï½·çª¶å ‹ï½¦çª¶å ™ï½©ï¿½ï½½B
	 */
	...
	/* ï¾†æ£šï¾†ç½®ï¾†æ·¡ï¾†å·½ï¾†èª°ï¾†æš–ï¾…ï½½ï¾ƒï½­çª¶æ°¾æ¨žï¿½ï¾‹ï¿½ï¿½ï¾ƒå§‘æ–­ï¾†é”ï¾†æ—¦ï¾…ï½½ï¾ƒï½­çª¶æ°¾æ¨žï¿½ï¾ƒï½°ï¾…ï½½ï¾ƒï½¦çª¶æ…Šï½¾ */
...
#endif
		/* ï¾†ä¸¹ï¾†åœï¿½ï¾†æ–­ï¿½ï½½[ï¾†æ­Žï¾†åœï¿½ï¾†åœï¿½çª¶å ™ï¿½Used_plane çª¶å ™ï½°ï¿½ï½½ï¾ƒæ˜¶ï¿½ï¾ƒï½¨çª¶å ‹ï½·çª¶å ™ï½©       */
		/* ï¾†ä¸¹ï¾†åœï¿½ï¾†æ–­ï¿½ï½½[ï¾†æ­Žï¾†åœï¿½ï¾†åœï¿½ï¾…ï½½wçª¶å‡–ï½¨(ï¾†ä¸¹ï¾†åœï¿½ï¾†æ–­ï¿½ï½½[ï¾†æ­Žï¾†åœï¿½ï¾†åœï¿½ï¾†ç¨šï¾†åœï¿½ï¾†ä¸¹ON çª¶å ‹ï½©çª¶å ™ï¿½çª¶ä½šï½¦2FG/BGçª¶å ™ï¿½ï¿½ï¾ƒå‚ï¿½ï¾ƒéºï¿½ï¾‚ï½¢) */
...
//		}
		...
		{
			/*
			 * çª¶ä½šï½¦2 FG/BG çª¶å ‹ï½ªçª¶å ‹ï¿½ï¿½ï¾ƒï½©çª¶å ™å¨¯ï¿½ï¾ƒï¿½ï¿½ï¾‚ï½»çª¶å ™ï½ªçª¶å ™é¯‰ï½¿ï½½Fçª¶ï½¢ï¾ƒç„¦ï¿½ï½·çª¶å ™ï½°ï¿½ï½½sçª¶å ‹ï½¤ï¿½ï½½B
			 */
			pucFGPointer = pucPtr;
			//pucBGPointer =  0;
			nSetSecond = TRUE;
			bFlag = true;
			/* çª¶ä½šï½¦2 FG/BG çª¶å ™ä¿„ï¿½ï¾‚ï½®ï¿½ï½½ï¾‚ï½«ï¾…ï½½wçª¶å‡–ï½¨çª¶å ‹ï½ªçª¶å ‹ï¿½ï¿½ï¾ƒï½©çª¶å ‹ï½©ï¾†è›‹ï¾†å·½ï¾†é›ï¾†èª°  */
				...
				OBJ_DEF_2ND)
			{
					...
					OBJ_MASK_2ND)
				{
					...
					case OBJ_IMAG_COLOR_2ND:
						nObjMode = OBJ_IMAG;
						/* gray modeçª¶å ™æˆ¸ï¿½å†·ï¿½ï¾ƒä¼šï½¿ï½½ï¾ƒæ˜¶ï¿½ï¾ƒï½¨çª¶å ‹ï½µçª¶å ™ï¿½ï¿½ï¾‚ï½¨çª¶å ‹ï½­ */
						nOrigObjMode =
							OBJ_IMAG_COLOR;
						break;
...
//todo
	...
	switch (ucColorMode)
	{
		...
		case PAGE_COLOR_CMY:	/* CMY çª¶å ™å“‰ä¸¹ï¾†æ¤Žæ§Œè¾°ï¾‹ï¿½ï½³ï¿½ï½½ï¾ƒï½¼çª¶ï½¢ï¾ƒï½»ï¾…ï½½ï¾‚ï½®çª¶å ™ï¿½ï¿½ï¾ƒå¯‚ï¿½ï¾…ï½¾ */
		case PAGE_COLOR_RK2:
		{
			...
			/* ï¾†æ£šï¾†ç½®ï¾†æ·¡ï¾†å·½ï¾†èª°ï¾†æš–çª¶çªï¿½ï¿½ï¾ƒå«ï½½wçª¶å‡–ï½¨çª¶å ‹ï½³çª¶å ™ï½ªçª¶å ‹ï½½ï¾†ä¸¹ï¾†æ¤Žæ§Œè¾°ï¾‹ï¿½ï½³ï¿½ï½½ï¾ƒï½¼çª¶ï½¢ï¾ƒï½»ï¾…ï½½ï¾‚ï½®çª¶å ™ï½°çª¶åï½²çª¶å ™å†·ï¿½ï¾ƒï½© */
			ulGmod = ulVectorGray;
			...
			switch (nObjMode)
			{
				case OBJ_IMAG:
					...
					/*
					 * StretchBlt(COLOR)çª¶å ™æ¾ï½¿ï½½ï¾ƒï½­çª¶å ™çƒRAY_CMYK
					 * StretchBlt(MONO)çª¶å ™éšˆ2Kï¾‹ï¿½é—‡ï¿½çª¶å ™ï¿½RAY_CMYK
					 * çª¶å ™éºï¿½ï¾ƒå¨¯ï¿½ï¾ƒï¿½ï¿½ï¾‚ï½®ï¿½ï½½ï¾‚ï½«ï¾…ï½½wçª¶å‡–ï½¨çª¶å ™ï¿½ï¿½ï¾ƒï¿½ï¿½ï¾‚ï½¯çª¶ç½µçª¶å ™å¨¯ï¿½ï¾‚ï½®çª¶å ‹ï½«çª¶å ™ä¿„ï¿½ï¾‚ï½·çª¶å ™ï½©ï¿½ï½½B
					 */
					switch (nOrigObjMode &
						OBJ_MASK_1ST)
					{
						case OBJ_IMAG_COLOR:
						/* ABOUTKçª¶å ™å§‘è¾°ï¾†æŠµï½¿ï½½ï¿½ï½½[ï¾†æ·¡çª¶å ™å®2Kçª¶å ™ï¿½ï¿½ï¾‚ï½¯çª¶å ‹ï½¶
						   MAYBEKçª¶å ™è¡Œetcolorçª¶å ™ä¿„ï¿½ï¾ƒå‚ï¿½Kçª¶ç‰Œçª¶å ™éºï¿½ï¾‚ï½¢ */
							if ((ulGmod != GRAY_CMY)
								&& (ulGmod != GRAY_HGRCMYK)
								&& (ulGmod != GRAY_PIXELK)
								&& (ulGmod != GRAY_IMAGEK))
						...
						case OBJ_IMAG_MONO:
							...
							{//ï¾†åœï¿½ï¾†çŸ¥ï¾†è¾°ï¾†æŠµï½¿ï½½ï¿½ï½½[ï¾†æ·¡çª¶å ™æ —MAGEKçª¶å ™å®2K
								ulGmod = GRAY_G2K;
							}
							break;
						default:
							/* Stretchblt, Bitbltçª¶å ™éºï¿½ï¾ƒï½§çª¶å ‹ï½±çª¶å ‹ï½¿çª¶å ™ï½§ */
							break;
					}
					break;
				case OBJ_GRAP:
...
//				}
			...
			{
			/* ï¾…ï½½wçª¶å‡–ï½¨çª¶å ‹ï½³çª¶å ™ï½ªçª¶å ‹ï½½ï¾†ä¸¹ï¾†æ¤Žæ§Œè¾°ï¾‹ï¿½ï½³ï¿½ï½½ï¾ƒï½¼çª¶ï½¢ï¾ƒï½»ï¾…ï½½ï¾‚ï½®çª¶å ™ï¿½RGB->CMYK çª¶ï½¢ï¾ƒç„¦ï¿½ï½·çª¶å ‹ï½·çª¶å ™ï½© */
			switch (ulGmod)
			{
				case GRAY_G2K:
				case GRAY_PIXELK:
