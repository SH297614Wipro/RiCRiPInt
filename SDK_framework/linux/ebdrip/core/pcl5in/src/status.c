...
unsigned char buffer1[20]="\0",buffer2[20]="\0",buffer3[20]="\0",buffer4[20]="\0",buffer5[20]="\0";
...
sprintf(buffer1,"%d",value.integer);
  ...
  PCL5Numeric   value)
{
 ...
 /* buff2 = (unsigned char *)value.integer;*/

  sprintf(buffer2,"%d",value.integer);
  ...
  PCL5Numeric   value)
{
 ...
 /*buff3 = (unsigned char *)value.integer;*/
sprintf(buffer3,"%d",value.integer);
...
sprintf(buffer4,"%d",value.integer);
...
sprintf(buffer5,"%d",value.integer);
