...
/** \mainpage DI Library “à•”İŒvd—l‘
 *
 * –{d—l‘‚ÍADIiDevice Infomation) Library ‚Ì“à•”d—l‚ğ‹Lq‚µ‚½‚à‚Ì‚Å‚·B
 *
 * DI‚ÍAƒvƒŠƒ“ƒ^[ƒAƒvƒŠiˆÈ‰ºƒAƒvƒŠj‚ª“®ì‚·‚é‚½‚ß‚É•K—v‚Èî•ñ‚Ì’ñ‹Ÿ‚ğ
 * s‚¤ƒ‰ƒCƒuƒ‰ƒŠ‚Å‚·B
 * ƒAƒvƒŠ‚Å‚ÍAƒvƒŠƒ“ƒ^[‚Ì‚n‚r‚â‹@í‚ÉˆË‘¶‚µ‚½î•ñ‚ª•K—v‚Å‚·‚ªA‚»‚Ì‚æ‚¤
 * ‚È•Ï“®ƒpƒ‰ƒ[ƒ^‚ğDI‚©‚çæ“¾‚·‚é‚±‚Æ‚É‚æ‚èAƒp[ƒX•”AƒŒƒ“ƒ_ƒŠƒ“ƒO•”‚Æ
 * ‚¢‚Á‚½ˆ—•”•ª‚Ì”Ä—p«‚ğ‚‚ß‚Ü‚·B
 *
 * \date 2005/09
 * \author M.Kumagai
...
#define	DI_REQ_PAUSE    0x08	/* Š„‚è‚İ‚É‚æ‚éˆê’â~—v‹ */
...
#define	DI_REQ_INTRAY		0x100	/* ‹‹†ƒgƒŒƒCî•ñŠm”F—v‹iMSISŒnPDLê—p */
...
#define DI_NOTIFYMSG_STRING		0x03	/* •¶š—ñ‚É‚æ‚éó‘Ô‚Ì’Ê’m */
#define DI_NOTIFYMSG_ERRFORCE		0x11	/* ƒGƒ‰[‚Ì‹­§’Ê’m */
#define DI_NOTIFYMSG_START		0x12	/* –¾¦“I‚È‹N“®’Ê’m */
#define DI_NOTIFYMSG_FINISH_FONTCOUNT	0x13	/* ƒtƒHƒ“ƒgƒJƒEƒ“ƒg‚ÌI—¹’Ê’m */
#define DI_NOTIFYMSG_PAUSE		0x14	/* ˆê’â~—v‹‚É‘Î‚·‚é‰“šiŠ®—¹A‚à‚µ‚­‚Íˆê’â~‚Å‚«‚È‚¢j’Ê’m */
...
/*
 *ˆêŸ’â~—v‹‚É‘Î‚·‚é‰“š‚Ìˆø”
 */
#define DI_INTERP_PAUSE_OK	0	/* ˆê’â~‚µ‚½ */
#define DI_INTERP_PAUSE_NG	-1	/* ˆê’â~‚Å‚«‚È‚¢ */
 ...
 * ƒR[ƒ‹ƒoƒbƒNŠÖ”‚Ìw’è
 */
/* di_singetc “Ç‚İ‚İ¸”s‚Ì‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_READERR_SINGETC		0x01
/* di_singet “Ç‚İ‚İ¸”s‚Ì‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_READERR_SINGET		0x02
/* di_singetc ƒTƒCƒYw’è•s³‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_SIZEERR_SINGET		0x03
/* ƒVƒXƒeƒ€‚©‚çƒf[ƒ^ˆ—‚ÌŠJn—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_PROCDATA		0x11
/* ƒVƒXƒeƒ€‚©‚çƒCƒ“ƒ^ƒvƒŠƒ^I—¹—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_EXIT			0x12
/* ƒVƒXƒeƒ€‚©‚çƒf[ƒ^ˆ—‚Ì’†~—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_CANCEL			0x13
/* ƒVƒXƒeƒ€‚©‚çƒIƒ“ƒ‰ƒCƒ“—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_ONLINE			0x14
/* ƒVƒXƒeƒ€‚©‚çƒIƒtƒ‰ƒCƒ“—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_OFFLINE			0x15
/* ƒVƒXƒeƒ€‚©‚çƒeƒXƒgƒvƒŠƒ“ƒg—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_TESTPRINT		0x16
/* ƒVƒXƒeƒ€‚©‚ç‹‹†ƒgƒŒƒC‚Ì•ÏX’Ê’m‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_TRAYINFO		0x17
/* ƒVƒXƒeƒ€‚©‚ç”r†ƒrƒ“‚Ì•ÏX’Ê’m‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_BININFO			0x18
/* ƒVƒXƒeƒ€‚©‚ç‹­§”r†—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_EXITPAPER		0x19
/* ƒVƒXƒeƒ€‚©‚çƒtƒHƒ“ƒg”‚ÌƒJƒEƒ“ƒg—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_FONTCOUNT		0x1A
/* ƒVƒXƒeƒ€‚©‚çƒvƒŠƒ“ƒ^ƒXƒe[ƒ^ƒXî•ñ‚Ì•ÏX’Ê’m‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_PRTSTATUS		0x1B
/* ƒVƒXƒeƒ€‚©‚çƒKƒ“ƒ}ÄŒvZ‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_GAM				0x1C
/* ƒVƒXƒeƒ€‚©‚çƒf[ƒ^ˆ—‚Ìˆê’â~—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_PAUSE				0x1D
/* ƒVƒXƒeƒ€‚©‚çƒf[ƒ^ˆ—‚Ìˆ—ÄŠJ—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_RESUME				0x1E
/* ƒVƒXƒeƒ€‚©‚çƒƒjƒ…[ƒAƒCƒeƒ€‚Ì“o˜^—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
#define DI_CALLBACK_REQ_MENU_INIT			0x20
/* ƒVƒXƒeƒ€‚©‚çƒƒjƒ…[‰æ–Ê‚ÌI—¹—v‹‚ª‚«‚½‚ÉƒR[ƒ‹‚·‚éŠÖ” */
...
/*
 * di_get_appinfo( )‚Ì’l‚ğŠi”[‚·‚é”z—ñ‚ÌÅ‘å’·
 */
 ...
 * ‚·‚®ã‚àdi_get_envdata( )‚Åg—p‚µ‚Ä‚¢‚é
 */
#define DI_ENV_TOOLONG_VALUE  -4

/*
 * di_soutput‚Åw’è‚·‚é‘‚«‚İ•û–@
 */
...
#define DI_MENU_TYPE_TRAY     5    /* ƒgƒŒƒCİ’èƒƒjƒ…[ */
#define DI_MENU_TYPE_EMUSET   8    /* ƒGƒ~ƒ…ƒŒ[ƒVƒ‡ƒ“ˆóüğŒƒƒjƒ…[ */
#define DI_MENU_TYPE_PRN_NUM  9    /* ƒGƒ~ƒ…ƒŒ[ƒVƒ‡ƒ“ˆóü•””ƒƒjƒ…[ */
#define DI_MENU_TYPE_PCL     15    /* PCLˆóüğŒƒjƒ…[ */

#define   DI_ITEM_TYPE_START        0  /* ƒ‹[ƒg\‘¢‘ÌƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_MENU         1  /* ƒƒjƒ…[Œ^‰æ–Ê—pƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_EXECUTING    3  /* ÀsŒ^‰æ–Ê—pƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq  */
#define   DI_ITEM_TYPE_SELECT       2  /* ‘I‘ğˆŒ^‰æ–Ê—pƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_INTEGER      5  /* ®”’lŒ^‰æ–Ê—pƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_FLOAT        6  /* ¬”’lŒ^‰æ–Ê—pƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_PRN_NUM      8  /* ˆóü•””‰æ–Ê—pƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_PTIME       14  /* —p†•Ï”{—¦ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_ANY         15  /* ”CˆÓƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_FLOAT_EXT   16  /* ¬”’lŒ…Šg’£“Á‰»Œ^ƒAƒCƒeƒ€ƒ^ƒCƒv¯•Êq */
#define   DI_ITEM_TYPE_PTIME_FLT   20  /* ¬”Œ^—p†•Ï”{—¦ƒ^ƒCƒv¯•Êq */


#define DI_INTERP_TESTPRINT_SUMMARY			-1	/* ƒCƒ“ƒ^ƒvƒŠƒ^ƒTƒ}ƒŠ[(ˆóüğŒ)ˆóü */
#define DI_INTERP_TESTPRINT_FONTSET				1	/* ƒtƒHƒ“ƒgƒZƒbƒgˆóü */
#define DI_INTERP_TESTPRINT_FONTALL				2	/* ‘S•¶šˆóü */
...
#define DI_INTERP_TESTPRINT_COLORSHIFT_SET		11	/* ’è’…‘¬“x•â³İ’è—p */
...
typedef struct di_ditinfo {
	...
	unsigned char	dit_order;		/* ƒfƒBƒU‚ÌƒI[ƒ_’lg—pON/OFF */
									/* [0: g—p‚µ‚È‚¢, 0x40: g—p‚·‚é] */
...
typedef struct di_resoinfo {
	unsigned int	x;	/* å‘–¸•ûŒü‰ğ‘œ“x */
	unsigned int	y;	/* •›‘–¸•ûŒü‰ğ‘œ“x */
} reso_info_t, di_resoinfo_t;

/* ‰ğ‘œ“x\‘¢‘Ì(ƒrƒbƒg‚Æ‚Ì‘g‡‚¹) */
typedef struct di_resolutioninfo {
	unsigned int	x;		/* å‘–¸•ûŒü‰ğ‘œ“x */
	unsigned int	y;		/* •›‘–¸•ûŒü‰ğ‘œ“x */
	unsigned char	bit;		/* ƒrƒbƒg” */
	unsigned char   paper;		/* †í */
...
typedef struct di_tlimitinfo {
	di_resolutioninfo_t	reso;	/* ‰ğ‘œ“xBall 0‚È‚ç‰ğ‘œ“x‚Ìw’è‚È‚µ */
	int					text;	/* •¶šƒIƒuƒWƒFƒNƒg‚Ì‘—Ê‹K§’l */
	int					line;	/* ü‰æƒIƒuƒWƒFƒNƒg‚Ì‘—Ê‹K§’l */
	int					phot;	/* Ê^ƒIƒuƒWƒFƒNƒg‚Ì‘—Ê‹K§’l */
...
typedef struct di_onetrayinfo {
	...
	unsigned char	p_size;			/* —p†ƒTƒCƒY(di_paperdef.hQÆ) */
#define DI_PAPER_AUTO          (0x00)          /* †íw’è‚È‚µ */
#define DI_PAPER_NORMAL        (0x01)          /* •’Ê† */
#define DI_PAPER_RECYCLE       (0x02)          /* Ä¶† */
#define DI_PAPER_SPECIAL       (0x03)          /* “Áê† */
#define DI_PAPER_TRACING       (0x04)          /* ƒgƒŒ[ƒVƒ“ƒO† */
#define DI_PAPER_OHP           (0x05)          /* OHP */
#define DI_PAPER_LABEL         (0x06)          /* ƒ‰ƒxƒ‹† */
#define DI_PAPER_BOND          (0x07)          /* ƒ{ƒ“ƒh† */
#define DI_PAPER_CARDSTOCK     (0x08)          /* ƒJ[ƒhƒXƒgƒbƒN */
#define DI_PAPER_CARDBOARD     (0x09)          /* Œú† */
#define DI_PAPER_PREPRINT      (0x0A)          /* ˆóüÏ‚İ† */
#define DI_PAPER_LETTER_HEAD   (0x0B)          /* ƒŒƒ^[ƒwƒbƒh† */
#define DI_PAPER_LTHEAD        (0x0B)          /* ”p~—\’è */
#define DI_PAPER_PUNCH         (0x0C)          /* ƒpƒ“ƒ`Ï‚İ† */
#define DI_PAPER_PREPUNCH      (0x0C)          /* ”p~—\’è */
#define DI_PAPER_TAB           (0x0D)          /* ƒ^ƒu† */
#define DI_PAPER_COLOR         (0x0E)          /* F† */
#define DI_PAPER_NORMAL2ND     (0x0F)          /* •’Ê†(— –Ê) */
#define DI_PAPER_CARDBOARD2ND  (0x10)          /* Œú†(— –Ê) */
#define DI_PAPER_THIN          (0x11)          /* ”–† */
#define DI_PAPER_GLOSSY        (0x12)          /* Œõ‘ò† */
#define DI_PAPER_USED          (0x13)          /* — †ig—pÏ‚İj */
#define DI_PAPER_POSTCARD      (0x14)          /* ƒnƒKƒL */
#define DI_PAPER_POSTCARD2ND   (0x15)          /* ƒnƒKƒL(— –Ê) */
#define DI_PAPER_CARDBOARD2    (0x16)          /* Œú†‚Q */
#define DI_PAPER_FILM          (0x17)          /* ƒtƒBƒ‹ƒ€†i}–ÊƒRƒs[—pj */
#define DI_PAPER_INKPOST       (0x18)          /* ƒCƒ“ƒNƒWƒFƒbƒg—p‚Í‚ª‚« */
#define DI_PAPER_HG_NORMAL     (0x19)          /* HG•’Ê† */
#define DI_PAPER_ENVELOPE      (0x1A)          /* ••“› */
#define DI_PAPER_CARDBOARD3    (0x1B)          /* Œú†‚R */
#define DI_PAPER_SPECIAL2      (0x1C)          /* “Áê†‚Q */
#define DI_PAPER_SPECIAL3      (0x1D)          /* “Áê†‚R */
#define DI_PAPER_MIDDLETHICK   (0x1E)          /* ’†ŒúŒû */
#define DI_PAPER_COATED        (0x1F)          /* ƒR[ƒg† */
#define DI_PAPER_CARDBOARD2REV (0x20)          /* Œú†‚Q(— –Ê) */
#define DI_PAPER_CARDBOARD3REV (0x21)          /* Œú†‚R(— –Ê) */
#define DI_PAPER_NORMAL2       (0x22)          /* •’Ê†‚Q */
#define DI_PAPER_THICKGLOSSY   (0x23)          /* ŒúèŒõ‘ò† */
#define DI_PAPER_SPECIAL4      (0x24)          /* “Áê†‚S */
#define DI_PAPER_SPECIAL5      (0x25)          /* “Áê†‚T */
#define DI_PAPER_SPECIAL6      (0x26)          /* “Áê†‚U */
#define DI_PAPER_USER_DEF1     (0x30)          /* ƒ†[ƒUw’è‚P */
#define DI_PAPER_USER_DEF2     (0x31)          /* ƒ†[ƒUw’è‚Q */
#define DI_PAPER_USER_DEF3     (0x32)          /* ƒ†[ƒUw’è‚R */
#define DI_PAPER_USER_DEF4     (0x33)          /* ƒ†[ƒUw’è‚S */
#define DI_PAPER_USER_DEF5     (0x34)          /* ƒ†[ƒUw’è‚T */
#define DI_PAPER_USER_DEF6     (0x35)          /* ƒ†[ƒUw’è‚U */
#define DI_PAPER_USER_DEF7     (0x36)          /* ƒ†[ƒUw’è‚V */
#define DI_PAPER_USER_DEF8     (0x37)          /* ƒ†[ƒUw’è‚W */
#define DI_PAPER_USER_DEF0     (0x38)          /* ƒ†[ƒUw’è‚Oi–¢“o˜^ƒJƒXƒ^ƒ€†íj */
#define DI_PAPER_COLOR1        (0x40)          /* F†‚P           */
#define DI_PAPER_COLOR2        (0x41)          /* F†‚Q           */
#define DI_PAPER_COLOR_WHITE   (0x50)          /* g—p•s‰Â(•W€) */
...
#define DI_PAPER_COLOR_ORANGE  (0x56)          /* ò */
...
#define DI_PAPER_NONE          (0x80)          /* ƒgƒŒƒC‚Éİ’è‚³‚ê‚Ä‚¢‚é†í(“Á’èPDL‚©‚ÂƒgƒŒƒCw’è‚Ì‚İg—p‰Â) */
#define DI_PAPER_USER_DEF9			(0x81)	/* ƒ†[ƒUw’è‚X(IMSS) */
#define DI_PAPER_USER_DEF10			(0x82)	/* ƒ†[ƒUw’è‚P‚O(IMSS) */
#define DI_PAPER_USER_DEF11			(0x83)	/* ƒ†[ƒUw’è‚P‚P(IMSS) */
#define DI_PAPER_USER_DEF12			(0x84)	/* ƒ†[ƒUw’è‚P‚Q(IMSS) */
#define DI_PAPER_USER_DEF13			(0x85)	/* ƒ†[ƒUw’è‚P‚R(IMSS) */
#define DI_PAPER_USER_DEF14			(0x86)	/* ƒ†[ƒUw’è‚P‚S(IMSS) */
#define DI_PAPER_USER_DEF15			(0x87)	/* ƒ†[ƒUw’è‚P‚T(IMSS) */
#define DI_PAPER_USER_DEF16			(0x88)	/* ƒ†[ƒUw’è‚P‚U(IMSS) */
#define DI_PAPER_USER_DEF17			(0x89)	/* ƒ†[ƒUw’è‚P‚V(IMSS) */
#define DI_PAPER_USER_DEF18			(0x8A)	/* ƒ†[ƒUw’è‚P‚W(IMSS) */
#define DI_PAPER_USER_DEF19			(0x8B)	/* ƒ†[ƒUw’è‚P‚X(IMSS) */
#define DI_PAPER_USER_DEF20			(0x8C)	/* ƒ†[ƒUw’è‚Q‚O(IMSS) */
#define DI_PAPER_USER_DEF21			(0x8D)	/* ƒ†[ƒUw’è‚Q‚P(IMSS) */
#define DI_PAPER_USER_DEF22			(0x8E)	/* ƒ†[ƒUw’è‚Q‚Q(IMSS) */
#define DI_PAPER_USER_DEF23			(0x8F)	/* ƒ†[ƒUw’è‚Q‚R(IMSS) */
#define DI_PAPER_USER_DEF24			(0x90)	/* ƒ†[ƒUw’è‚Q‚S(IMSS) */
#define DI_PAPER_USER_DEF25			(0x91)	/* ƒ†[ƒUw’è‚Q‚T(IMSS) */
#define DI_PAPER_USER_DEF26			(0x92)	/* ƒ†[ƒUw’è‚Q‚U(IMSS) */
#define DI_PAPER_USER_DEF27			(0x93)	/* ƒ†[ƒUw’è‚Q‚V(IMSS) */
#define DI_PAPER_USER_DEF28			(0x94)	/* ƒ†[ƒUw’è‚Q‚W(IMSS) */
#define DI_PAPER_USER_DEF29			(0x95)	/* ƒ†[ƒUw’è‚Q‚X(IMSS) */
#define DI_PAPER_USER_DEF30			(0x96)	/* ƒ†[ƒUw’è‚R‚O(IMSS) */
#define DI_PAPER_USER_DEF31			(0x97)	/* ƒ†[ƒUw’è‚R‚P(IMSS) */
#define DI_PAPER_USER_DEF32			(0x98)	/* ƒ†[ƒUw’è‚R‚Q(IMSS) */
#define DI_PAPER_USER_DEF33			(0x99)	/* ƒ†[ƒUw’è‚R‚R(IMSS) */
#define DI_PAPER_USER_DEF34			(0x9A)	/* ƒ†[ƒUw’è‚R‚S(IMSS) */
#define DI_PAPER_USER_DEF35			(0x9B)	/* ƒ†[ƒUw’è‚R‚T(IMSS) */
#define DI_PAPER_USER_DEF36			(0x9C)	/* ƒ†[ƒUw’è‚R‚U(IMSS) */
#define DI_PAPER_USER_DEF37			(0x9D)	/* ƒ†[ƒUw’è‚R‚V(IMSS) */
#define DI_PAPER_USER_DEF38			(0x9E)	/* ƒ†[ƒUw’è‚R‚W(IMSS) */
#define DI_PAPER_USER_DEF39			(0x9F)	/* ƒ†[ƒUw’è‚R‚X(IMSS) */
#define DI_PAPER_USER_DEF40			(0xA0)	/* ƒ†[ƒUw’è‚S‚O(IMSS) */
#define DI_PAPER_USER_DEF41			(0xA1)	/* ƒ†[ƒUw’è‚S‚P(IMSS) */
#define DI_PAPER_USER_DEF42			(0xA2)	/* ƒ†[ƒUw’è‚S‚Q(IMSS) */
#define DI_PAPER_USER_DEF43			(0xA3)	/* ƒ†[ƒUw’è‚S‚R(IMSS) */
#define DI_PAPER_USER_DEF44			(0xA4)	/* ƒ†[ƒUw’è‚S‚S(IMSS) */
#define DI_PAPER_USER_DEF45			(0xA5)	/* ƒ†[ƒUw’è‚S‚T(IMSS) */
#define DI_PAPER_USER_DEF46			(0xA6)	/* ƒ†[ƒUw’è‚S‚U(IMSS) */
#define DI_PAPER_USER_DEF47			(0xA7)	/* ƒ†[ƒUw’è‚S‚V(IMSS) */
#define DI_PAPER_USER_DEF48			(0xA8)	/* ƒ†[ƒUw’è‚S‚W(IMSS) */
#define DI_PAPER_USER_DEF49			(0xA9)	/* ƒ†[ƒUw’è‚S‚X(IMSS) */
#define DI_PAPER_USER_DEF50			(0xAA)	/* ƒ†[ƒUw’è‚T‚O(IMSS) */
#define DI_PAPER_USER_DEF51			(0xAB)	/* ƒ†[ƒUw’è‚T‚P(IMSS) */
#define DI_PAPER_USER_DEF52			(0xAC)	/* ƒ†[ƒUw’è‚T‚Q(IMSS) */
#define DI_PAPER_USER_DEF53			(0xAD)	/* ƒ†[ƒUw’è‚T‚R(IMSS) */
#define DI_PAPER_USER_DEF54			(0xAE)	/* ƒ†[ƒUw’è‚T‚S(IMSS) */
#define DI_PAPER_USER_DEF55			(0xAF)	/* ƒ†[ƒUw’è‚T‚T(IMSS) */
#define DI_PAPER_USER_DEF56			(0xB0)	/* ƒ†[ƒUw’è‚T‚U(IMSS) */
#define DI_PAPER_USER_DEF57			(0xB1)	/* ƒ†[ƒUw’è‚T‚V(IMSS) */
#define DI_PAPER_USER_DEF58			(0xB2)	/* ƒ†[ƒUw’è‚T‚W(IMSS) */
#define DI_PAPER_USER_DEF59			(0xB3)	/* ƒ†[ƒUw’è‚T‚X(IMSS) */
#define DI_PAPER_USER_DEF60			(0xB4)	/* ƒ†[ƒUw’è‚U‚O(IMSS) */
#define DI_PAPER_USER_DEF61			(0xB5)	/* ƒ†[ƒUw’è‚U‚P(IMSS) */
#define DI_PAPER_USER_DEF62			(0xB6)	/* ƒ†[ƒUw’è‚U‚Q(IMSS) */
#define DI_PAPER_USER_DEF63			(0xB7)	/* ƒ†[ƒUw’è‚U‚R(IMSS) */
#define DI_PAPER_USER_DEF64			(0xB8)	/* ƒ†[ƒUw’è‚U‚S(IMSS) */
#define DI_PAPER_USER_DEF65			(0xB9)	/* ƒ†[ƒUw’è‚U‚T(IMSS) */
#define DI_PAPER_USER_DEF66			(0xBA)	/* ƒ†[ƒUw’è‚U‚U(IMSS) */
#define DI_PAPER_USER_DEF67			(0xBB)	/* ƒ†[ƒUw’è‚U‚V(IMSS) */
#define DI_PAPER_USER_DEF68			(0xBC)	/* ƒ†[ƒUw’è‚U‚W(IMSS) */
#define DI_PAPER_USER_DEF69			(0xBD)	/* ƒ†[ƒUw’è‚U‚X(IMSS) */
#define DI_PAPER_USER_DEF70			(0xBE)	/* ƒ†[ƒUw’è‚V‚O(IMSS) */
#define DI_PAPER_USER_DEF71			(0xBF)	/* ƒ†[ƒUw’è‚V‚P(IMSS) */
#define DI_PAPER_USER_DEF72			(0xC0)	/* ƒ†[ƒUw’è‚V‚Q(IMSS) */
#define DI_PAPER_USER_DEF73			(0xC1)	/* ƒ†[ƒUw’è‚V‚R(IMSS) */
#define DI_PAPER_USER_DEF74			(0xC2)	/* ƒ†[ƒUw’è‚V‚S(IMSS) */
#define DI_PAPER_USER_DEF75			(0xC3)	/* ƒ†[ƒUw’è‚V‚T(IMSS) */
#define DI_PAPER_USER_DEF76			(0xC4)	/* ƒ†[ƒUw’è‚V‚U(IMSS) */
#define DI_PAPER_USER_DEF77			(0xC5)	/* ƒ†[ƒUw’è‚V‚V(IMSS) */
#define DI_PAPER_USER_DEF78			(0xC6)	/* ƒ†[ƒUw’è‚V‚W(IMSS) */
#define DI_PAPER_USER_DEF79			(0xC7)	/* ƒ†[ƒUw’è‚V‚X(IMSS) */
#define DI_PAPER_USER_DEF80			(0xC8)	/* ƒ†[ƒUw’è‚W‚O(IMSS) */
#define DI_PAPER_USER_DEF81			(0xC9)	/* ƒ†[ƒUw’è‚W‚P(IMSS) */
#define DI_PAPER_USER_DEF82			(0xCA)	/* ƒ†[ƒUw’è‚W‚Q(IMSS) */
#define DI_PAPER_USER_DEF83			(0xCB)	/* ƒ†[ƒUw’è‚W‚R(IMSS) */
#define DI_PAPER_USER_DEF84			(0xCC)	/* ƒ†[ƒUw’è‚W‚S(IMSS) */
#define DI_PAPER_USER_DEF85			(0xCD)	/* ƒ†[ƒUw’è‚W‚T(IMSS) */
#define DI_PAPER_USER_DEF86			(0xCE)	/* ƒ†[ƒUw’è‚W‚U(IMSS) */
#define DI_PAPER_USER_DEF87			(0xCF)	/* ƒ†[ƒUw’è‚W‚V(IMSS) */
#define DI_PAPER_USER_DEF88			(0xD0)	/* ƒ†[ƒUw’è‚W‚W(IMSS) */
#define DI_PAPER_USER_DEF89			(0xD1)	/* ƒ†[ƒUw’è‚W‚X(IMSS) */
#define DI_PAPER_USER_DEF90			(0xD2)	/* ƒ†[ƒUw’è‚X‚O(IMSS) */
#define DI_PAPER_USER_DEF91			(0xD3)	/* ƒ†[ƒUw’è‚X‚P(IMSS) */
#define DI_PAPER_USER_DEF92			(0xD4)	/* ƒ†[ƒUw’è‚X‚Q(IMSS) */
#define DI_PAPER_USER_DEF93			(0xD5)	/* ƒ†[ƒUw’è‚X‚R(IMSS) */
#define DI_PAPER_USER_DEF94			(0xD6)	/* ƒ†[ƒUw’è‚X‚S(IMSS) */
#define DI_PAPER_USER_DEF95			(0xD7)	/* ƒ†[ƒUw’è‚X‚T(IMSS) */
#define DI_PAPER_USER_DEF96			(0xD8)	/* ƒ†[ƒUw’è‚X‚U(IMSS) */
#define DI_PAPER_USER_DEF97			(0xD9)	/* ƒ†[ƒUw’è‚X‚V(IMSS) */
#define DI_PAPER_USER_DEF98			(0xDA)	/* ƒ†[ƒUw’è‚X‚W(IMSS) */
#define DI_PAPER_USER_DEF99			(0xDB)	/* ƒ†[ƒUw’è‚X‚X(IMSS) */
#define DI_PAPER_USER_DEF100		(0xDC)	/* ƒ†[ƒUw’è‚P‚O‚O(IMSS) */

	unsigned char	p_kind;			/* †í’è‹`(‚·‚®ã‚Ìdefine) */
...
#define DI_TRAY_MSIZESENSE_VALID	(1 << 20)	/* (attr) è·‚µ©“®ƒTƒCƒYŒŸ’m—LŒø */
...
#define DI_TRAY_SMALLSIZE_TYPE  (1 << 24)   /* (attr) ¬ƒTƒCƒYƒgƒŒƒCİ’è‚ªON */
	unsigned long	attr;			/* ƒgƒŒƒCí—Ş(‚·‚®ã‚Ìdefine) */
...
#define DI_TRAY_DOOR_OPEN      (1 << 13)
	...
	unsigned long	p_length;		/* —p†‚‚³(0.1mm’PˆÊ) */
	unsigned long	p_width;		/* —p†•(0.1mm’PˆÊ) */
} tray_info_t, di_onetrayinfo_t;

typedef struct di_trayinfo {
	long				tray_num;					/* ƒgƒŒƒC” */
	di_onetrayinfo_t	trayinfo[GPS_MAX_TRAY_NUM];	/* ŠeƒgƒŒƒC‚Ìî•ñ */
} di_trayinfo_t;
...
#define DI_OPT_EXT_ROLL_FEEDER2        (1 << 17)       /* Roll Unit2 */
	unsigned long	tray;		/* ‹‹†ŒnƒIƒvƒVƒ‡ƒ“‹@Šíƒtƒ‰ƒO */
...
#define DI_OPT_EXT_SUPERIOR            (1 << 28)       /* SUPERIOR */
	unsigned long	bin;		/* ”r†ŒnƒIƒvƒVƒ‡ƒ“‹@Šíƒtƒ‰ƒO */
...
#define DI_OPT_EXT_FIN_HUDOSON         (15)    /* GAIA_P1—pFIN –{‘Ì”r†‚ğ‚Â‚Ô‚µ‚ÄƒXƒe[ƒvƒ‹‚Ì‚İ‰Â”\ */
...
#define	DI_SYS_FUNC_USB				(1 << 19)	/* USB */
#define	DI_SYS_FUNC_BLUETOOTH		(1 << 21)	/* Bluetooth */
	unsigned long		function_disable;	/* ‹@”\g—p•s‰Â(SC) */
...
#define	DI_STATE_INT_REQ			(1 << 9)		/* Š„‚İƒRƒs[iˆóü’â~j—v‹ */
#define	DI_STATE_INT_PAUSE			(1 << 10)	/* Š„‚İƒRƒs[’† */
...
#define	DI_STATE_CARDSAVE			(1 << 31)	/* ƒJ[ƒhƒZ[ƒu */
	unsigned long		state_detail;		/* ó‘Ô‚ÌÚ×‚ğƒrƒbƒg‚Å‚ ‚ç‚í‚· */
...
typedef struct di_res_reqpaper{
	...
	int				pid;
	int				result;		/* Œ‹‰Ê */
#define	DI_TRAY_FOUND	(0)		/* ğŒ‚É‡‚¤ƒgƒŒƒC‚ªoŒ»‚µ‚½ */
#define	DI_TRAY_ERRSKIP	(1)		/* ƒGƒ‰[ƒXƒLƒbƒv‚µ‚Ä‚­‚¾‚³‚¢ */
#define	DI_TRAY_CANCEL	(2)		/* ƒLƒƒƒ“ƒZƒ‹‚ªw¦‚³‚ê‚½ */
#define	DI_TRAY_FORCE	(3)		/* ‹­§ˆóü‚ªw¦‚³‚ê‚½ */
#define	DI_TRAY_ANOTHER	(4)		/* —p†ƒTƒCƒY‚ª—Ş—‚µ‚½ƒgƒŒƒC‘¶İ */
	int			tray_id;		/* ƒgƒŒƒCID */
	int			paper_code;		/* —p†ƒTƒCƒYƒR[ƒh */
	int			paper_width;	/* —p†•   (0.1mm’PˆÊ) */
	int			paper_length;	/* —p†‚‚³ (0.1mm’PˆÊ) */
} di_res_reqpaper_t;
...
typedef  struct {
	unsigned short idPanel;   /* ƒAƒCƒeƒ€©g‚Ìƒpƒlƒ‹‚h‚c */
...
typedef  struct {
	unsigned short idPanel;    /* ƒAƒCƒeƒ€©g‚Ìƒpƒlƒ‹‚h‚c */
	unsigned short idNext;     /* “¯ŠK‘w‚ÌŸ‚Ìƒpƒlƒ‹‚h‚c */
	unsigned short idPrev;     /* “¯ŠK‘w‚Ì‘O‚Ìƒpƒlƒ‹‚h‚c */
	unsigned short idDown;     /* ‰ºŠK‘w‚Ìƒpƒlƒ‹‚h‚c */
	unsigned short idBack;     /* ŒÄo‚µŒ³ ãˆÊŠK‘w‚Ìƒpƒlƒ‹‚h‚c */
	unsigned short str1_id;    /* ƒ^ƒCƒgƒ‹•”i‚Ps–Új‚Ì•¶š—ñ‚h‚c */
	unsigned short str1_mod;   /* ƒ^ƒCƒgƒ‹•”i‚Ps–Új‚Ì•¶š—ñCüî•ñ */
	unsigned short str2_id;    /* €–Ú•”i‚Qs–Új‚Ì•¶š—ñ‚h‚c */
    /* ƒgƒ‰ƒbƒv—pŠÖ”ƒ|ƒCƒ“ƒ^ */
	void (*fchecker)(unsigned short, unsigned char, unsigned char);
	unsigned char  disp_flg;   /* •\¦^”¼‹P“x^”ñ•\¦‚Ìƒtƒ‰ƒO */
...
typedef  struct {
	...
	/* ƒgƒ‰ƒbƒv—pŠÖ”ƒ|ƒCƒ“ƒ^ */
	void (*fchecker)(unsigned short, unsigned char, unsigned char);
	unsigned char  up_num;   /* ÀsŒã‚É‘JˆÚ‚·‚éã‚Ö‚ÌŠK‘w” */
	unsigned char  disp_flg; /* •\¦^”¼‹P“x^”ñ•\¦‚Ìƒtƒ‰ƒO */
	unsigned char  fselect;  /* ‘I‘ğ^”ñ‘I‘ğ‚Ìƒtƒ‰ƒO */
	unsigned char  disp_fselect; /* ‘I‘ğƒtƒ‰ƒO‚Ì•\¦^”ñ•\¦‚Ìƒtƒ‰ƒO */
...
typedef  struct {
	...
	/* ƒgƒ‰ƒbƒv—pŠÖ”ƒ|ƒCƒ“ƒ^ */
	void (*fchecker)(unsigned short, unsigned char, unsigned char);
	unsigned short msr_id;         /* ’PˆÊ•¶š—ñ‚h‚c */
	unsigned char  up_num;         /* ÀsŒã‚É‘JˆÚ‚·‚éã‚Ö‚ÌŠK‘w” */
	unsigned char  fig_num;        /* •\¦Œ…” */
	unsigned char  ucReserved[2];  /* –¢g—p */
	unsigned char  reserve_cid[4]; /* ƒNƒ‰ƒCƒAƒ“ƒg‚h‚c•Û‘¶—p—\–ñ—Ìˆæ */
	unsigned char  ucItem;         /* ƒAƒCƒeƒ€ƒ^ƒCƒv */
	unsigned char  ucMenu;         /* ƒƒjƒ…[ƒ^ƒCƒv */
...
typedef  struct {
	...
	void           (*fchecker)(unsigned short, unsigned char, unsigned char);
	unsigned short msr_id;  /* ’PˆÊ•¶š—ñ‚h‚c                       */
	unsigned char  str1_mod; /* ƒ^ƒCƒgƒ‹•”i‚Ps–Új‚Ì•¶š—ñCüî•ñ */
...
#define DI_MACHINECODE_DIANA_C1L		0x00490000	/* Diana-C1L group */
	 ...
	 */
	unsigned long	machinecode;	/**< ‹@íƒR[ƒh */
	...
	unsigned char	disp_lines;		/* •\¦‰æ–Ê‚Ìƒ‰ƒCƒ“” */
	unsigned char	disp_columns;	/* •\¦‰æ–Ê‚Ì‚Pƒ‰ƒCƒ“‚Ì•¶š” */
...
#define DI_DEST_EU		2	/* EU */
	unsigned char	destination;	/* dŒü‚¯’nƒR[ƒh(‚·‚®ã‚Ìdefine) */
	unsigned long	memory_size;	/* ƒCƒ“ƒ^ƒvƒŠƒ^‚ªg—p‚Å‚«‚é */
					/* ƒƒ‚ƒŠƒTƒCƒY(Byte) */
...
{
	di_resolution_info_t reso;	/* ‰ğ‘œ“x&?[‚³ */
	int text;	/* •¶šƒIƒuƒWƒFƒNƒg */
	int line;	/* ?ü‰æƒIƒuƒWƒFƒNƒg */
	int phot;	/* Ê?^ƒIƒuƒWƒFƒNƒg */
...
typedef struct di_dupgaminfo {
	unsigned char	*gam_front;	/* •\–ÊŠ„‡[Ê^,•¶š,“h‚è,ü‰æ] */
	unsigned char	*gam_back;	/* — –ÊŠ„‡[Ê^,•¶š,“h‚è,ü‰æ] */
} di_dupgaminfo_t;
...
typedef struct di_devinfo {
	 ...
	 * ƒfƒBƒUî•ñ
	 * ÀÛ‚Ì”‚Í
	 *  ƒTƒ|[ƒgƒrƒbƒg” x ‰ğ‘œ“xí—Ş” x ƒfƒBƒUí—Ş” x ƒTƒ|[ƒgÅ‘åƒvƒŒ[ƒ“”
	 * ‚Æ‚È‚éBŠe’l‚Í‹@í”\—Íî•ñB
	 * ”z’u‡‚Í
	 *  for ƒrƒbƒg”(’l ¬ -> ‘å)
	 *    for ‰ğ‘œ“x”(å‘–¸+•›‘–¸ ¬ -> ‘å)
...
#define DI_FONT_PCL			4	/* PCL—p */
	 ...
	 * ‹@í”\—Íî•ñ
	 */
	unsigned int		resonum;	/* ƒTƒ|[ƒg‰ğ‘œ“x&ƒrƒbƒg‘g‚İ‡‚í‚¹í—Ş” */
	di_resolutioninfo_t	*reso_set;	/* ‰ğ‘œ“x&ƒrƒbƒg‘g‡‚¹ */
						/* reso•ª‚ ‚é(=reso_set[resonum]) */
	int		ndit;		/* ƒfƒBƒUí—Ş” */
	int		nplane;		/* ƒTƒ|[ƒgÅ‘åƒvƒŒ[ƒ“” */
	float	bg_startp;	/* BG ‚ªn‚Ü‚éŠJnƒŒƒxƒ‹ */
	float	bg_slant;	/* BG ’¼üŒù”z */
	float	ucr_startp;	/* UCR ‚ªn‚Ü‚éŠJnƒŒƒxƒ‹ */
	float	ucr_slant;	/* UCR ’¼üŒù”z */
	int		soft_tsave;	/* ƒ\ƒtƒgƒgƒi[ƒZ[ƒu‚ÌƒTƒ|[ƒg */
				/* [1:‚ ‚è, 0:‚È‚µ] */
	float	tsave_ratio;	/* ƒ\ƒtƒgƒgƒi[ƒZ[ƒuŠ„‡(0.0 - 1.0) */
	int		extend_soft_tsave;	/* Šg’£ƒ\ƒtƒgƒgƒi[ƒZ[ƒu‚Ì‘Î‰ */
					/* [1:‚ ‚è, 0:‚È‚µ] */
	int		toner_limit;	/* ‘—Ê‹K§‚ÌƒTƒ|[ƒg */
				/* [1:‚ ‚è, 0:‚È‚µ] */
	unsigned int	tlimit_num;	/* ‹@í‚ªƒTƒ|[ƒg‚µ‚Ä‚¢‚é‘—Ê‹K§’l‚Ìí—Ş” */
...
#define DI_SUPPORT_EXT_DEVINFO_PARAM	1 /* ‚±‚êˆÈ~‚Ìƒƒ“ƒo‚ª—LŒø */
	...
	int	support_drop;	/* “K—Ê‚ÌƒTƒ|[ƒg */
				/* [1:‚ ‚è, 0:‚È‚µ] */
	int		cmy_media_num;	/* CMYˆóü‚ğ‚·‚é†í‚Ì” */
	unsigned char	*cmy_media;	/* CMYˆóü‚ğ‚·‚é†í‚Ì”z—ñ */
	int		minbandheight;
	int		maxbandheight;
	int		bandsize;
...
typedef struct di_async_para {
	 ...
	 * ƒeƒXƒgƒvƒŠƒ“ƒg‹@”\‚ğƒTƒ|[ƒg‚µ‚Ä‚¢‚éŠÂ‹«‚Ì‚İ•K—vB
	 */
	int	testprint;
	/*
	 * ƒlƒbƒgƒWƒ‡ƒuID
	...
	/*
	 * ƒvƒƒOƒ‰ƒ€”Ô† 
	 * ƒVƒXƒeƒ€‚©‚çƒvƒƒOƒ‰ƒ€“o˜^/íœ—v‹‚ª‚ ‚Á‚½‚ÉXV‚³‚ê‚éiMSISŒnPDLê—pj
	 * ’l‚ÌƒNƒŠƒA‚Íƒ†[ƒU‚ª–¾¦“I‚És‚Á‚Ä‚­‚¾‚³‚¢
	 */
	int	pno;
	/*
	 * ƒVƒXƒeƒ€‚©‚çƒvƒ‰ƒCƒ€ƒŠƒZƒbƒg—v‹‚ª‚ ‚Á‚½‚É”ñ‚O‚ÉXV‚³‚ê‚éiMSISŒnPDLê—pj
	 * ’l‚ÌƒNƒŠƒA‚Íƒ†[ƒU‚ª–¾¦“I‚És‚Á‚Ä‚­‚¾‚³‚¢
	 */
	int	prime_reset;
	/*
	 * ƒ†[ƒUƒXƒCƒbƒ`”Ô†
	 * ƒVƒXƒeƒ€‚©‚çˆóü—v‹‚ª‚ ‚Á‚½‚ÉXV‚³‚ê‚éiMSISŒnPDLê—pj
	 */
	int		uswitch;
	/*
	 * ƒf[ƒ^ˆ—ŠJn——R
...
typedef struct di_setinfo {
	/*
	 * ”ñ“¯Šú‚É•Ï‰»‚·‚éƒpƒ‰ƒ[ƒ^
	 * Œ»óGPSã‚Ì“®ì‚Å‚Ì‚İ—LŒø
	 */
	di_async_para_t	*async;
	/*
	 * DI‚ªƒXƒgƒŠ[ƒ€‚©‚ç“Ç‚İ‚ñ‚¾ƒoƒCƒg”B
	 * di_singet(c) or di_sinseek ‚ğƒR[ƒ‹‚·‚é‚½‚Ñ‚É©“®“I‚ÉXV‚³‚ê‚éB
	 * DEBUG‚ğdefine‚µ‚ÄƒRƒ“ƒpƒCƒ‹‚µ‚½ê‡‚Ì‚İ—LŒø
	 */
	int	cmd_offset;
	/*
...
#define DI_INTERP_MP_JPEG		0x11001	/* MediaPrintJPEG */
	 int	interp_id;
	/*
	 * ƒVƒXƒeƒ€‰Šú‰»‚Ì‚½‚ß‚ÌƒIƒvƒVƒ‡ƒ“ƒpƒ‰ƒ[ƒ^(-1‚Å–¢g—p)
...
#define DI_BIN_FOLD               (1 << 7)        /* Ü‚è‹@”\ */
	unsigned long	attr;	/* ”r†ƒrƒ“‚Ìí—Ş */
#define DI_BIN_FULL               (1 << 0)        /* –”t */
#define DI_BIN_ERROR              (1 << 1)        /* ŒÌáó‘Ô */
#define DI_BIN_STOPEXIT           (1 << 2)        /* ”r†—}§ */
#define DI_BIN_SADDLE_DISABLE     (1 << 3)        /* ’†’Ô‚¶”r†‹Ö~ */
#define DI_BIN_NORMAL_DISABLE     (1 << 4)        /* ’†’Ô‚¶ˆÈŠO‚Ì”r†‹Ö~ */
...
#define	DI_CHKDIR_STAPLE     (1<<0)	    /* stapleƒpƒ‰ƒ[ƒ^w’è */
#define DI_CHKDIR_PUNCH      (1<<1)	    /* punchƒpƒ‰ƒ[ƒ^w’è */
#define DI_CHKDIR_BINDING    (1<<2)	    /* bindingƒpƒ‰ƒ[ƒ^w’è */
#define DI_CHKDIR_RESOLUTION (1<<3)	    /* reso_x‚Æreso_yƒpƒ‰ƒ[ƒ^w’è */
#define DI_CHKDIR_DEPTH      (1<<5)	    /* depthƒpƒ‰ƒ[ƒ^w’è */
	unsigned long		flag;			/* İ’è‚·‚éƒpƒ‰ƒ[ƒ^ */
	int					psize;			/* —p†ƒTƒCƒYi•K{j */
	unsigned long		pwidth;			/* —p†•i0.1mm’PˆÊj */
	unsigned long		plength;		/* —p†’·i0.1mm’PˆÊj */
...
#define DI_STAPLE_LEFT_TOP_HORIZ   (1)  /* g—p‚Í„§‚µ‚È‚¢ */
#define DI_STAPLE_LEFT_TOP_VERT    (2)  /* g—p‚Í„§‚µ‚È‚¢ */
#define DI_STAPLE_LEFT_TOP_SLANT   (3)  /* ¶ãÎ‚ß */
#define DI_STAPLE_RIGHT_TOP_HORIZ  (5)  /* g—p‚Í„§‚µ‚È‚¢ */
#define DI_STAPLE_RIGHT_TOP_VERT   (6)  /* g—p‚Í„§‚µ‚È‚¢ */
#define DI_STAPLE_RIGHT_TOP_SLANT  (7)  /* ‰EãÎ‚ß */
...
#define DI_PUNCH_JP2   (0x00)           /* ãˆÊ‚Ìƒpƒ“ƒ`í—Ş‚Ìw’è‚Í‚ ‚Á‚Ä‚à‚È‚­‚Ä‚à—Ç‚¢ */
...
#define DI_BIND_BOTTOM    (3)           /* ‰º’Ô‚¶(–¢g—p) */
#define DI_BIND_LEFTRIGHT (4)           /* ¶‰E’Ô‚¶(RTIFF) */
#define DI_BIND_TOPBOTTOM (5)           /* ã‰º’Ô‚¶(RTIFF) */
#define DI_BIND_OFF       (0xF)         /* w’è‚È‚µ(gpsPlotChkDirection()—p) */
	unsigned char		binding;		/* ‚Æ‚¶•ûŒü */
	unsigned short		reso_x;			/* X•ûŒü‚Ì‰ğ‘œ“x */
	unsigned short		reso_y;			/* Y•ûŒü‚Ì‰ğ‘œ“x */
...
#define DI_ROT_ERROR (0)    /* ƒGƒ‰[ (’Ê†•s‰Â‚È‚Ç) */
...
#define DI_ROT_180B  (1<<2)	/* ‚P‚W‚O“x */
#define DI_ROT_270B  (1<<3)	/* ‚Q‚V‚O“x */
#define DI_ROT_ERROR (0)	/* Î‚ßƒXƒe[ƒvƒ‹o—ˆ‚È‚¢A–”‚Íƒpƒ‰ƒ[ƒ^–³ŒøiƒXƒe[ƒvƒ‹w’è‚µ‚Ä‚¢‚È‚¢ê‡‚È‚Çj */
	int slantdirection;		/* Î‚ßƒXƒe[ƒvƒ‹‚ª‚Å‚«‚é‰æ‘œ•ûŒü */
} di_imgrotinfo_t;
...
typedef struct di_progtable {
	...
	unsigned char file_no;	/*ƒGƒ~ƒ…ƒŒ[ƒVƒ‡ƒ“’PˆÊ‚ÅŠÇ—‚³‚ê‚Ä‚¢‚éƒvƒƒOƒ‰ƒ€”Ô†BNVRAMƒtƒ@ƒCƒ‹‚Ìƒtƒ@ƒCƒ‹”Ô†‚É‘Î‰‚·‚éB */
} di_progtable_t;

#define	DI_AUTH_LIMIT_ADMINMACHINE	(1 << 0)		/* ‹@ŠíŠÇ—Ò‹@”\ 	*/
#define	DI_AUTH_LIMIT_ADMINUSER		(1 << 1)		/* ƒ†[ƒU[ŠÇ—Ò‹@”\ */
#define	DI_AUTH_LIMIT_ADMINDOCUMENT	(1 << 2)		/* •¶‘ŠÇ—Ò‹@”\ 	*/
#define	DI_AUTH_LIMIT_ADMINNETWORK	(1 << 3)		/* ƒlƒbƒgƒ[ƒNŠÇ—Ò‹@”\ */
...
/**
 * \brief DI I/F‚Ì‰Šú‰»A‹y‚Ñ»•iî•ñ‚Ìæ“¾‚ğs‚È‚¤B
 *
 * \param initinfo DI‚ª’l‚ğƒZƒbƒg‚·‚é\‘¢‘ÌB
 * \param setinfo  DI‚É“n‚·Šeíƒpƒ‰ƒ[ƒ^BŒ»óGPS‚Ì‚İ‚Å—LŒøB
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ¸”s
 *
 ...
 *  \li DI_INTERP_PS
 *  \li DI_INTERP_PCL
 * \pre ˆø” setinfo->async ‚ªƒAƒNƒZƒX‰Â”\(GPS“®ì‚Ì‚İ)B
 *
 * \post di_term() ‚ªƒR[ƒ‹‚³‚ê‚é‚Ü‚Å di_init() ‚Íg—p•s‰Â”\B
 * \post di_term() ‚ªƒR[ƒ‹‚³‚ê‚é‚Ü‚Ådi_init()‚ğœ‚­‘S‚Ä‚Ì‚c‚h‚ÌƒCƒ“ƒ^[
 * ƒtƒF[ƒX‚ªg—p‰Â”\B
 * \post di_term()‚ªƒR[ƒ‹‚³‚ê‚é‚Ü‚Åsetinfo->async‚ÌŠeƒpƒ‰ƒ[ƒ^‚ª”ñ“¯Šú
 * ‚ÉXV‚³‚ê‚é(GPS“®ì‚Ì‚İ)B
 * \post ƒpƒlƒ‹‚É‚c‚h‚ğg—p‚µ‚Ä‚¢‚éƒvƒŠƒ“ƒ^ƒAƒvƒŠ–¼•\¦(GPS“®ì‚Ì‚İ)B
 * \post ˆø” *initinfo “à‚Ìƒƒ“ƒo‚ª“KØ‚È’l‚ÉXV‚³‚ê‚éB
 */
extern EXPORT int di_init( di_initinfo_t *initinfo, di_setinfo_t *setinfo );

/**
 * \brief DI‚ªƒZƒbƒg‚µ‚½ƒpƒ‰ƒ[ƒ^‚ğƒNƒŠƒA‚·‚éB
 *
 *  \param devinfo   î•ñ‚ªŠi”[‚³‚ê‚Ä‚¢‚é\‘¢‘ÌB
 *  \param free_func –{ŠÖ”“à‚Åƒƒ‚ƒŠ‚ğ‰ğ•ú‚·‚é‚½‚ß‚ÌƒR[ƒ‹ƒoƒbƒNŠÖ”B
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ¸”s
 *
 ...
 *
 * \post di_getinfo()‚ÅŠm•Û‚µ‚½ƒƒ‚ƒŠ‚ÍAfree_func‚ğg—p‚µ‚Ä‰ğ•ú‚³‚ê‚éB
 * \post *devinfo‚Ìƒpƒ‰ƒ[ƒ^‚Íƒ[ƒƒNƒŠƒA‚³‚ê‚éB
 */
extern EXPORT int di_clear( di_devinfo_t *devinfo, DI_CALLBACK_MEMFREE free_func );

/**
 * \brief DI I/F‚ÌI—¹ˆ—‚ğs‚È‚¤B
 *
 * \post di_init(),di_term()‚ğœ‚­‘S‚Ä‚Ì‚c‚h‚ÌƒCƒ“ƒ^[ƒtƒF[ƒX‚ªg—p•s‰ÂB
 * \post ƒvƒŠƒ“ƒ^‚n‚r‚ªA‚c‚h‚ğg—p‚µ‚Ä‚¢‚éƒvƒŠƒ“ƒ^ƒAƒvƒŠ‚ÌI—¹‚ğ”F¯B
 */
extern EXPORT void di_term();

/**
 * \brief ƒvƒŠƒ“ƒ^ƒAƒvƒŠ‚Ì‹N“®‚©‚çI—¹‚Ü‚Å•Ï‰»‚µ‚È‚¢‹@íˆË‘¶î•ñ‚Ìæ“¾‚ğ
 *s‚È‚¤B
 *
 *  \param devinfo î•ñ‚ğŠi”[‚·‚é\‘¢‘ÌB
 *  \param alloc_func –{ŠÖ”“à‚Åƒƒ‚ƒŠ‚ğŠm•Û‚·‚é‚½‚ß‚ÌƒR[ƒ‹ƒoƒbƒNŠÖ”B
 ...
 *
 * \retval 0     ³íI—¹
 * \retval DI_GI_ERR_CONDITION  –‘OğŒ‚ğ–‚½‚µ‚Ä‚¢‚È‚¢
 * \retval DI_GI_ERR_DITHER     dither_info æ“¾¸”s
 * \retval DI_GI_ERR_GAMMA      gamma_info æ“¾¸”s
 * \retval DI_GI_ERR_FONT       font_address & font_size æ“¾¸”s
 * \retval DI_GI_ERR_PROF       profaddress & profnumber æ“¾¸”s
 * \retval DI_GI_ERR_RESO       resonum & reso_set æ“¾¸”s
 * \retval DI_GI_ERR_NDIT       ndit æ“¾¸”s
 * \retval DI_GI_ERR_NPLANE     nplane æ“¾¸”s
 * \retval DI_GI_ERR_BGUCR      bg_(startp/slant) & ucr_(startp/slant)
 *æ“¾¸”s
 * \retval DI_GI_ERR_TSAVE      soft_tsave æ“¾¸”s
 * \retval DI_GI_ERR_TSAVE_R    tsave_ratio æ“¾¸”s
 * \retval DI_GI_ERR_TLIMIT     toner_limit æ“¾¸”s
 * \retval DI_GI_ERR_TLIMIT_R   tlimit_num & tlimit_val æ“¾¸”s
 * \retval DI_GI_ERR_SHDM       shdm_addr æ“¾¸”s
 * \retval DI_GI_ERR_SYSH       sys_handle æ“¾¸”s
 * \retval DI_GI_ERR_EXTENDTSAVE      extend_soft_tsave æ“¾¸”s
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre *devinfo‚ªƒAƒNƒZƒX‰Â”\B
 * \pre alloc_func( size )‚ğƒR[ƒ‹‚·‚é‚ÆAsize ‚¾‚¯Šm•Û‚µ‚½ƒƒ‚ƒŠ‚Ìæ“ª
 *ƒAƒhƒŒƒX‚Ì’l‚ª•Ô‚Á‚Ä‚­‚éB
 * \pre dither_gamma_file ‚Æ‚¢‚¤ƒtƒ@ƒCƒ‹‚ª‘¶İ‚·‚éA‚à‚µ‚­‚Í
 *dither_gamma_file‚ªNULLB
 * \pre alloc_func‚Åæ“¾‚·‚éƒƒ‚ƒŠƒTƒCƒY‚ÍAGPSŠÂ‹«‚Å–ñ300ByteAGPSˆÈŠO
...
/**
 * \brief ƒvƒŠƒ“ƒ^‚n‚r‚©‚çƒCƒxƒ“ƒg—v‹‚ğæ“¾‚·‚éB
 *
...
/**
 * \brief ƒgƒŒƒCî•ñ‚Ìæ“¾‚ğs‚¤B
 *
 * \param trayinfo ƒgƒŒƒCî•ñ‚ğŠi”[‚·‚é\‘¢‘Ì
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[AƒgƒŒƒCî•ñæ“¾¸”s
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
...
/**
 * \brief ƒAƒvƒŠŒÅ—Lî•ñ‚©‚çw’èƒJƒeƒSƒŠ‚ÌƒL[‚Ì’l‚ğæ“¾‚·‚éB
 *
 * \param key      ŒŸõƒL[(•¶š—ñ)
 * \param category ŒŸõƒJƒeƒSƒŠ(•¶š—ñ)
 * \param value    ŒŸõŒ‹‰Ê(•¶š—ñ)‚ğŠi”[‚·‚é—Ìˆæ
 *
 ...
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre key‚Ì•¶š”‚ªƒ^[ƒ~ƒl[ƒg‚ğŠÜ‚ß1•¶šˆÈã32•¶šˆÈ“à
 * \pre category‚Ì•¶š”‚ªƒ^[ƒ~ƒl[ƒg‚ğŠÜ‚ß1•¶šˆÈã32•¶šˆÈ“à
 * \pre value[0]`value[DI_MAX_VALUE_LEN-1]‚Ü‚ÅƒAƒNƒZƒX‰Â”\
 *
 * \post ŒŸõ‚µ‚½•¶š—ñ‚ªvalue‚É‘‚«‚Ü‚ê‚éB•¶š—ñ‚ªDI_MAX_VALUE_LEN
 *‚æ‚è’·‚¢ê‡‚ÍADI_MAX_VALUE_LEN-1‚Ü‚Å‚Ì•¶š—ñ‚ğæ“¾‚µ‚ÄA
 *value[DI_MAX_VALUE_LEN-1]‚ÉI’[•¶š‚ğ’Ç‰Á‚·‚éB
 */
extern EXPORT int di_get_appinfo(char *key, char *category, char value[]);

/**
 * \brief ŠÂ‹«•Ï”‚Ì’l‚ğæ“¾‚·‚éB
 *
 * \param table_name ŠÂ‹«•Ï”ƒe[ƒuƒ‹–¼
 * \param id         ŠÂ‹«•Ï”ID
 * \param val        “¾‚ç‚ê‚½ŠÂ‹«•Ï”‚Ì’l
 *
 * \retval  1 ³íI—¹iŠÂ‹«•Ï”‚ª–¾¦“I‚Éw’è‚³‚ê‚Ä‚¢‚éj
 * \retval  0 ³íI—¹iŠÂ‹«•Ï”‚ª–¾¦“I‚Éw’è‚³‚ê‚Ä‚È‚¢‚½‚ßAƒfƒtƒHƒ‹
 *ƒg’lƒZƒbƒg)
 * \retval -1 ƒGƒ‰[idi_init()‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚È‚¢j
 * \retval -2 ƒGƒ‰[itable_name‚ª‘¶İ‚µ‚È‚¢j
 * \retval -3 ƒGƒ‰[iw’è‚µ‚½ŠÂ‹«•Ï”‚ª‚È‚¢j
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre table_name‚Æ‚¢‚¤ƒe[ƒuƒ‹‚ª‘¶İ‚·‚éB
 * \pre ŠÂ‹«•Ï” id ‚ªAtable_name‚É‘¶İ‚·‚éB
 * \pre *val‚ªƒAƒNƒZƒX‰Â”\B
 *
 * \post *val‚Éw’è‚µ‚½ŠÂ‹«•Ï”‚Ì’l‚ªŠi”[‚³‚ê‚éB
 */
extern EXPORT int di_get_envvalue( char *table_name, long id, long *val );

/**
 * \brief ŠÂ‹«•Ï”‚Ì’l‚ğƒZƒbƒg‚·‚éB
 *
 * \param table_name ŠÂ‹«•Ï”ƒe[ƒuƒ‹–¼
 * \param id         ŠÂ‹«•Ï”ID
 ...
 * \retval -5 ƒGƒ‰[i val ‚ªİ’è•s‰Â”\‚È’lj
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre table_name‚Æ‚¢‚¤ƒe[ƒuƒ‹‚ª‘¶İ‚·‚éB
 * \pre ŠÂ‹«•Ï” id ‚ªAİ’è‰Â”\‚È•Ï”‚Æ‚µ‚Ätable_name‚É‘¶İ‚·‚éB
 *
 * \post di_set_envvalue( table_name, id, k )‚Æ‚¢‚¤Œ`®‚Å–{ŠÖ”‚ğƒR[
...
/**
 * \brief DI‚Ì“Á’è‚Ìƒ^ƒCƒ~ƒ“ƒO‚ÅƒR[ƒ‹‚·‚éŠÖ”‚ğw’è‚·‚éB
 *
 * \param type ˆø” func ‚Åw’è‚³‚ê‚½ƒR[ƒ‹ƒoƒbƒNŠÖ”‚ğƒR[ƒ‹‚·‚éƒ^ƒCƒ~ƒ“ƒOB
 *Še’l‚É‘Î‚·‚éƒ^ƒCƒ~ƒ“ƒO‚ÍˆÈ‰º‚Ì‚Æ‚¨‚èB
 *  <table>
 *   <tr>
 *    <td>DI_CALLBACK_READERR_SINGETC</td>
 *    <td>di_singetc() “à‚Å“Ç‚İ‚İ‚ª¸”s‚µ‚½ê‡</td>
 *   </tr>
 *   <tr>
 *    <td>DI_CALLBACK_READERR_SINGET</td>
 *    <td>di_singet( )“à‚Å“Ç‚İ‚İ‚ª¸”s‚µ‚½ê‡</td>
 *   </tr>
 *   <tr>
 *    <td>DI_CALLBACK_SIZEERR_SINGET</td>
 *    <td>di_singet( )‚Ìˆø”‚ÅAƒTƒCƒYw’è‚ª•s³‚¾‚Á‚½ê‡</td>
 *   </tr>
 *   <tr>
 *    <td>DI_CALLBACK_REQ_PROCDATA</td>
 *    <td>ƒVƒXƒeƒ€‚©‚çƒf[ƒ^ˆ—‚ÌŠJn—v‹‚ª‚«‚½ê‡</td>
 *   </tr>
 *   <tr>
 ...
 *    <td>ƒVƒXƒeƒ€‚©‚ç‹‹†ƒgƒŒƒC‚Ì•ÏX’Ê’m‚ª‚«‚½ê‡</td>
 *   </tr>
 *   <tr>
 *    <td>DI_CALLBACK_REQ_BININFO</td>
 *    <td>ƒVƒXƒeƒ€‚©‚ç”r†ƒrƒ“‚Ì•ÏX’Ê’m‚ª‚«‚½ê‡</td>
 *   </tr>
 *   <tr>
 *    <td>DI_CALLBACK_REQ_EXITPAPER</td>
 *    <td>ƒVƒXƒeƒ€‚©‚ç‹­§”r†—v‹‚ª‚«‚½ê‡</td>
 *   </tr>
 *   <tr>
 ...
 *    <td>ƒVƒXƒeƒ€‚©‚çƒKƒ“ƒ}‚ÌÄŒvZ—v‹‚ª‚«‚½ê‡</td>
 *   </tr>
 *  </table>
 * \param func w’è‚·‚éƒR[ƒ‹ƒoƒbƒNŠÖ”
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
 ...
 * \pre func ‚ªƒR[ƒ‹‰Â”\
 *
 * \post type ‚É‚æ‚èw’è‚³‚ê‚½ƒ^ƒCƒ~ƒ“ƒO‚Å func ‚ğƒR[ƒ‹‚·‚éB
 */
extern EXPORT int di_set_callbackfunc( int type, DI_CALLBACK_FUNC func );

/**
 * \brief ƒvƒŠƒ“ƒ^‚n‚r‚ªŠÇ—‚µ‚Ä‚¢‚éƒƒ‚ƒŠ‚ÌŠm•Û‚ğs‚¤B
 *
 * \param size Šm•Û‚·‚éƒƒ‚ƒŠƒTƒCƒY(Byte)
 *
 * \retval Šm•Û‚µ‚½ƒƒ‚ƒŠ‚Ìæ“ªƒAƒhƒŒƒX Šm•Û¬Œ÷
 * \retval NULL ƒGƒ‰[Aƒƒ‚ƒŠŠm•Û¸”s
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre di_memory_alloc()‚ª‚P“x‚àƒR[ƒ‹‚³‚ê‚Ä‚¢‚È‚¢(GPS“®ì‚Ì‚İ)
 *
...
/**
 * \brief di_memory_alloc() ‚ÅŠm•Û‚µ‚½ƒƒ‚ƒŠ‚Ì‰ğ•ú‚ğs‚¤B
 *
 * \param ptr ‰ğ•ú‚·‚éƒƒ‚ƒŠ‚Ìæ“ªƒAƒhƒŒƒX
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
 ...
 *
 * \post ‰ğ•ú‚µ‚½ƒƒ‚ƒŠ‚ÍAƒvƒŠƒ“ƒ^‚n‚r‚ª—˜—p‰Â”\
 */
extern EXPORT int di_memory_free(char *ptr);

/**
 * \brief “ü—ÍƒzƒXƒgƒoƒbƒtƒ@‚ğƒI[ƒvƒ“‚·‚éB
 * ƒf[ƒ^“Ç‚İ‚İ‘O‚É•K‚¸–{ŠÖ”‚ğƒR[ƒ‹‚·‚é‚±‚Æ
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
 ...
 *(di_get_request(),di_trans_process()QÆ)
 *
 * \post di_close_host()A‚à‚µ‚­‚Í di_trans_process() ‚ğƒR[ƒ‹‚·‚é‚Ü‚Å
 *ˆÈ‰º‚Ì I/F ‚ªg—p‰Â”\
 *  \li di_singetc()
 *  \li di_singet()
 *  \li di_sinpeekc()
...
/**
 * \brief di_open_host()‚É‚æ‚èƒI[ƒvƒ“‚³‚ê‚½ ƒzƒXƒgƒoƒbƒtƒ@‚ğƒNƒ[ƒY
 *‚·‚éB
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 ...
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 *
 * \post di_open_host() ‚ğƒR[ƒ‹‚·‚é‚Ü‚ÅˆÈ‰º‚ÌI/F‚ªg—p•s‰Â”\B
 *  \li di_singetc()
 *  \li di_singet()
 *  \li di_sinpeekc()
 *  \li di_sinpeek()
...
/**
 * \brief “ü—ÍƒXƒgƒŠ[ƒ€‚©‚ç‚PƒoƒCƒg‚Ì“Ç‚İ‚ŞB
 *
 * \param dat “Ç‚İ‚ñ‚¾ƒf[ƒ^‚Ì’l
 *
 * \retval 0     “Ç‚İ‚İ¬Œ÷
 * \retval 0ˆÈŠO ƒGƒ‰[A“Ç‚İ‚İ¸”sAEOF
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre ƒzƒXƒg‚ªƒI[ƒvƒ“‚³‚ê‚Ä‚¢‚éi di_open_host() QÆj
 * \pre *dat ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post *dat‚É“ü—ÍƒXƒgƒŠ[ƒ€‚Ìæ“ª‚PƒoƒCƒg‚ªŠi”[‚³‚ê‚éB
 * \post ƒŠ[ƒhƒ|ƒCƒ“ƒ^Aƒs[ƒNƒ|ƒCƒ“ƒ^‚ªŸ‚Ì“Ç‚İ‚İˆÊ’u‚ÉˆÚ“®‚·‚é
 */
extern EXPORT int di_singetc( unsigned char *dat );

/**
 * \brief “ü—ÍƒXƒgƒŠ[ƒ€‚©‚ç•¡”ƒoƒCƒg“Ç‚İ‚ŞB
 *
 * \param buf “Ç‚İ‚İæƒoƒbƒtƒ@
 * \param len “Ç‚İ‚ŞƒTƒCƒY(Byte)
 *
 * \retval >0 “Ç‚İ‚ñ‚¾ƒf[ƒ^‚ÌƒoƒCƒg”
 * \retval 0  EOF
 * \retval -1 ƒGƒ‰[
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre “ü—ÍƒzƒXƒg‚ªƒI[ƒvƒ“‚³‚ê‚Ä‚¢‚éi di_open_host() QÆj
 * \pre len ‚ª0ˆÈã
 * \pre len ‚ª1ˆÈã‚Ìê‡‚É buf[0]`buf[len-1] ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post buf‚É“ü—ÍƒXƒgƒŠ[ƒ€‚Ìæ“ªlenƒoƒCƒg‚ªŠi”[‚³‚ê‚éB
 * \post ƒŠ[ƒhƒ|ƒCƒ“ƒ^Aƒs[ƒNƒ|ƒCƒ“ƒ^‚ªŸ‚Ì“Ç‚İ‚İˆÊ’u‚ÉˆÚ“®‚·‚éB
 */
extern EXPORT int di_singet( unsigned char *buf, long len );

/**
 * \brief “ü—ÍƒXƒgƒŠ[ƒ€‚©‚ç‚PƒoƒCƒg“Ç‚İ‚ŞB
 *
 * “Ç‚İ‚ñ‚¾ƒf[ƒ^“à—e‚Í”jŠü‚µ‚È‚¢‚½‚ßAdi_reset_sinpeek() ‚É‚æ‚èÄ“Ç
 *‚İ‚İ‰Â”\B
 *
 * \param dat “Ç‚İ‚ñ‚¾ƒf[ƒ^‚Ì’l
 *
 * \retval 0     “Ç‚İ‚İ¬Œ÷
 * \retval 0ˆÈŠO ƒGƒ‰[AEOFA“Ç‚İ‚ñ‚¾ƒf[ƒ^‚ªƒzƒXƒgƒoƒbƒtƒ@‚ÌƒTƒCƒY
 *‚ğ’´‚¦‚½ê‡
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre ƒzƒXƒg‚ªƒI[ƒvƒ“‚³‚ê‚Ä‚¢‚éi di_open_host() QÆj
 * \pre *dat ‚ªƒAƒNƒZƒX‰Â”\
 * \pre “ü—ÍƒXƒgƒŠ[ƒ€‚ª hostI/Oi di_select_idevice()QÆj
 ...
 *
 * \retval >0 “Ç‚İ‚ñ‚¾ƒf[ƒ^‚ÌƒoƒCƒg”
 * \retval 0  EOFAƒs[ƒN‚Å“Ç‚İ‚ñ‚¾ƒf[ƒ^‚ªƒzƒXƒgƒoƒbƒtƒ@‚ÌƒTƒCƒY‚ğ
 *’´‚¦‚½ê‡
 * \retval -1 ƒGƒ‰[
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
...
/**
 * \brief ƒzƒXƒgƒoƒbƒtƒ@‚Ì“Ç‚İ‚İˆÊ’u‚ğA—LŒøƒf[ƒ^‚Ìæ“ª‚ÉˆÚ“®‚·‚éB
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
...
/**
 * \brief ƒzƒXƒgƒoƒbƒtƒ@‚É‘Î‚µ‚ÄAw’è‚µ‚½ƒoƒCƒg”‚¾‚¯“Ç‚İÌ‚Ä‚éB
 *
 * \param len “Ç‚İ‚ŞƒTƒCƒY(Byte)
 *
 * \retval 0     ³íI—¹
...
/**
 * \brief “ü—ÍƒXƒgƒŠ[ƒ€‚ğ•ÏX‚·‚éB
 *
 * ƒfƒtƒHƒ‹ƒg‚Í DI_HOST_IO
 *
 * \param mode ˆÈ‰º‚Ìw’è“ü—ÍƒXƒgƒŠ[ƒ€
 ...
 *    <td>DI_MEMORY_IO</td>
 *    <td>
 *      ƒƒ‚ƒŠ‚©‚ç“Ç‚İ‚ŞƒR[ƒ‹ƒoƒbƒNŠÖ”<br>
 *      Œ^:typedef int (*CALLBACK_MEMREAD)( unsigned char **, int * );<br>
 *      ‘æ‚Pˆø”: “Ç‚İ‚İæƒAƒhƒŒƒX<br>
 *      ‘æ‚Qˆø”: “Ç‚İ‚ŞƒTƒCƒY<br>
 *    </td>
 *   </tr>
 *   <tr>
 *    <td>DI_FILE_IO</td>
 ...
 * \pre opt ‚ª—LŒøƒpƒ‰ƒ[ƒ^iˆø”‚Ìà–¾QÆj
 *
 * \post di_singetc() , di_singet() ‚Ì“Ç‚İ‚İæ‚ª mode ‚É•ÏX‚³‚ê‚éB
 */
extern EXPORT int di_select_idevice( int mode, void *opt );

/**
 * \brief §Œä‚ğ‘¼ƒvƒƒZƒX‚ÖˆÚs‚·‚é
 *
 * –{ŠÖ”I—¹Œã‚ÍI/O‚ªØ‚è—£‚³‚ê‚½ó‘Ô‚Æ‚È‚é‚½‚ß,
 *Ä“xƒoƒbƒtƒ@‚©‚ç‚Ì“Ç‚İ‚İ‚ğs‚È‚¤ê‡‚Ídi_open_host()‚ğƒR[ƒ‹‚·‚é
 *‚±‚ÆB
 *
 * \return Ä“x§Œä‚ªˆÚs‚µ‚Ä‚«‚½‚ÌƒVƒXƒeƒ€‚©‚ç‚Ì—v‹
 * \retval DI_REQ_EXIT    I—¹—v‹
 * \retval DI_REQ_PROCESS ’Êíˆ——v‹
 ...
 *    <td>•¶š—ñ‚Ìæ“ªƒAƒhƒŒƒX</td>
 *   </tr>
 *   <tr>
 *    <td>DI_NOTIFYMSG_ERRFORCE</td>
 *    <td>ƒGƒ‰[ƒR[ƒh(Ú×‚ÍGPSd—l‘)</td>
 *   </tr>
 *   <tr>
 *    <td>DI_NOTIFYMSG_START</td>
 *    <td>ƒCƒ“ƒ^ƒvƒŠƒ^IDB di_setinfo_t QÆ</td>
 *   </tr>
 *   <tr>
 ...
 *    <td>’Ê’m‚·‚éó‘Ô<br>
 *        DI_INTERP_PAUSE_OK	iˆê’â~‚µ‚½j<br>
 *        DI_INTERP_PAUSE_NG	iˆê’â~‚Å‚«‚È‚¢j<br>
 *    </td>
 *   </tr>
 *   <tr>
 ...
 *opt‚Ìó‘Ô‚Æ”»’f‚·‚éB
 * \post msg ‚ª DI_NOTIFYMSG_ERRFORCE ‚È‚çAƒpƒlƒ‹‚Ö‚ÌƒGƒ‰[•\¦‚ÆƒGƒ‰
 *[ƒƒMƒ“ƒO”½‰f‚ğs‚¤B
 * \post msg ‚ª DI_NOTIFYMSG_STRING ‚È‚çAƒvƒŠƒ“ƒ^‚n‚r‚ÍƒvƒŠƒ“ƒ^ƒAƒvƒŠ
 *‚ª•¶š—ñw’è‚Ìó‘Ô‚É‚È‚Á‚½‚Æ”»’f‚·‚éB
...
/**
 * \brief w’è‚µ‚½—p†ƒTƒCƒY‚ğƒvƒŠƒ“ƒ^‚ªƒTƒ|[ƒg‚µ‚Ä‚¢‚é‚©–â‚¢‡‚í‚¹‚éB
 *
 * \param paper_id —p†ƒTƒCƒYID(GPS’è‹`)
 *
 ...
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 *
 * \post •Ô‚è’l‚ª‚P‚È‚çA‚»‚Ì—p†ƒTƒCƒY‚Åo—Í‰Â”\
 */
extern EXPORT int di_query_supportpaper( int paper_id );

/**
 * \brief ƒWƒ‡ƒu‚Éİ’è‚³‚ê‚Ä‚¢‚éƒIƒvƒVƒ‡ƒ“•¶š—ñ‚ğæ“¾‚·‚éB
 *
 * \param str ƒIƒvƒVƒ‡ƒ“•¶š—ñ‚Ìæ“ªƒAƒhƒŒƒX
 *
 * \retval  0 ¬Œ÷
 * \retval -1 ¸”s(w’è‚³‚ê‚½ƒIƒvƒVƒ‡ƒ“•¶š—ñ‚ğ“r’†‚Ü‚Å‚µ‚©æ“¾‚Å‚«‚È
 *‚©‚Á‚½)Bstr‚É‚Í“r’†‚Ü‚Å‚Ì•¶š—ñ‚ÌƒAƒhƒŒƒX‚ğ•Ô‚·
 * \retval -2 ¸”sAƒGƒ‰[
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 ...
 *
 * \post *str‚ÉƒIƒvƒVƒ‡ƒ“•¶š—ñ‚Ìæ“ªƒAƒhƒŒƒX‚ªŠi”[‚³‚ê‚éB
 */
extern EXPORT int di_get_optstr( char **str );

/**
 * \brief ƒGƒ‰[ƒvƒŠƒ“ƒg—p‚Ìƒoƒbƒtƒ@‚ÌƒAƒhƒŒƒXæ“¾
 *
 * \param buffer ¡‚Ü‚Å‚Ìƒoƒbƒtƒ@‚Ìæ“ªƒAƒhƒŒƒX
 * \param size   æ“¾‚µ‚½ƒoƒbƒtƒ@‚ÌƒTƒCƒY
 *
 * \retval æ“¾‚µ‚½ƒoƒbƒtƒ@‚Ìæ“ªƒAƒhƒŒƒX ³íI—¹
 * \retval NULL  ƒGƒ‰[
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 ...
 *
 * \post •Ô‚è’l‚Éæ“¾‚µ‚½ƒoƒbƒtƒ@‚Ìæ“ªƒAƒhƒŒƒX‚ª•Ô‚Á‚Ä‚­‚éB
 */
extern EXPORT char *di_get_epbuffer( char *buffer, int *size );

/**
 * \brief w’è‚µ‚½—p†‚ÌƒTƒCƒY‚ğæ“¾‚·‚é
 *
 * \param code   —p†ƒR[ƒh
 * \param width  —p†•i0.1mm’PˆÊj
 * \param length —p†’·‚³i0.1mm’PˆÊj
 *
 ...
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 *
 * \post *width ‚ª—p†ƒR[ƒh code ‚Ì—p†•‚Æ‚È‚é
 * \post *length ‚ª—p†ƒR[ƒh code ‚Ì—p†’·‚³‚Æ‚È‚é
 */
...
/**
 * \brief o—ÍƒzƒXƒgƒoƒbƒtƒ@‚ğƒI[ƒvƒ“‚·‚éB
 *
 * ƒf[ƒ^‘‚«‚İ‘O‚É•K‚¸–{ŠÖ”‚ğƒR[ƒ‹‚·‚é‚±‚Æ
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
 ...
 * di_trans_process() QÆj
 *
 * \post di_close_ohost() A‚à‚µ‚­‚Í di_trans_process() ‚ğƒR[ƒ‹‚·‚é‚Ü
 *‚ÅˆÈ‰º‚ÌI/F‚ªg—p‰Â”\B
 *  \li di_soutputc()
 *  \li di_soutput()
 *  \li di_soutflush()
 */
...
/**
 * \brief di_open_ohost() ‚É‚æ‚èƒI[ƒvƒ“‚³‚ê‚½ƒzƒXƒgƒoƒbƒtƒ@‚ğƒNƒ[ƒY
 *‚·‚éB
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 ...
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 *
 * \post di_open_ohost() ‚ğƒR[ƒ‹‚·‚é‚Ü‚ÅˆÈ‰º‚ÌI/F‚ªg—p•s‰Â”\B
 *  \li di_soutputc()
 *  \li di_soutput()
 *  \li di_soutflush()
 */
...
/**
 * \brief o—ÍƒXƒgƒŠ[ƒ€‚Ö‚PƒoƒCƒg‘‚«‚ŞB
 *
 * ‘—Mƒoƒbƒtƒ@‚É‘‚«‚İ—Ìˆæ‚ª‚È‚¢ê‡‚É‚ÍA‘—Mƒf[ƒ^‚ğ‘‚«‚Ş—Ìˆæ
 *‚ª‚Å‚«‚é‚Ü‚ÅƒuƒƒbƒN‚·‚éB
 *
 * \param dat ‘‚«‚Şƒf[ƒ^‚Ì’l
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[A‘‚«‚İ¸”s
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre o—ÍƒzƒXƒg‚ªƒI[ƒvƒ“‚³‚ê‚Ä‚¢‚éi di_open_ohost() QÆj
 *
 * \post ‘—Mƒoƒbƒtƒ@‚É dat ‚ª‘‚«‚Ü‚ê‚éB
 */
extern EXPORT int di_soutputc( unsigned char dat );

/**
 * \brief o—ÍƒXƒgƒŠ[ƒ€‚Ö•¡”ƒoƒCƒg‘‚«‚ŞB
 *
 * \param buf ‘‚«‚Şƒf[ƒ^
 * \param len “Ç‚İ‚ŞƒTƒCƒY(Byte)
 * \param flag ‘‚«‚İ•û–@
 ...
 *   <tr>
 *    <td>DI_HOST_BLOCK</td>
 *    <td>ƒmƒ“ƒuƒƒbƒNw’è‚È‚µB‘—Mƒoƒbƒtƒ@‚É‘‚«‚İ—Ìˆæ‚ª‚È‚¢ê‡‚É
 *        ‚ÍA‘—Mƒf[ƒ^‚ğ‘‚«‚Ş—Ìˆæ‚ª‚Å‚«‚é‚Ü‚ÅƒuƒƒbƒN‚·‚éB</td>
 *   </tr>
 *   <tr>
 *    <td>DI_HOST_NONBLOCK</td>
 *    <td> ƒmƒ“ƒuƒƒbƒNw’è‚ ‚èB‘—Mƒoƒbƒtƒ@‚ÌƒuƒƒbƒN‚Í‚µ‚È‚¢iƒoƒb
 *        ƒtƒ@‚ªˆì‚ê‚é‚Ü‚Å‘‚«‚İA‘‚«‚ß‚½ƒoƒCƒg”‚ğ–ß‚è’l‚Æ‚µ‚Ä•Ô
 *        ‚·jB</td>
 *   </tr>
 *  </table>
 *
 * \retval >=0 ‘‚«‚ñ‚¾ƒf[ƒ^‚ÌƒoƒCƒg”
 * \retval  -1 ƒGƒ‰[
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre o—ÍƒzƒXƒg‚ªƒI[ƒvƒ“‚³‚ê‚Ä‚¢‚éi di_open_ohost() QÆj
 ...
 * \pre len ‚ª1ˆÈã‚Ìê‡‚É buf[0]`buf[len-1] ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post buf ‚Ì“à—e‚ªo—ÍƒXƒgƒŠ[ƒ€‚É‘‚«‚Ü‚ê‚é
 */
extern EXPORT int di_soutput( unsigned char *buf, long len, int flag );

/**
 * \brief ‘—Mƒoƒbƒtƒ@’†‚É‘‚«‚Ü‚ê‚½‚ªA‚Ü‚¾‘—M‚³‚ê‚Ä‚¢‚È‚¢ƒf[ƒ^‚ğ
 *ƒzƒXƒg‚É‘—M‚·‚éB
 *
 * di_soutputc() ‚ ‚é‚¢‚Í di_soutput() ‚É‚Äˆê‹æØ‚è‚Ì‘—Mƒf[ƒ^‚ğ‘—M
 *ƒoƒbƒtƒ@‚É‘‚«‚ñ‚¾ŒãA•K‚¸A‚±‚ÌŠÖ”‚ğŒÄ‚Ô‚±‚ÆB
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
...
/**
 * \brief “ü—ÍƒXƒgƒŠ[ƒ€‚Ì—LŒøƒoƒCƒg”‚ğæ“¾‚·‚éB
 *
...
/**
 * \brief Œ»İw’è‚³‚ê‚Ä‚¢‚é—Dæ‹‹†ƒgƒŒƒCî•ñ‚ğæ“¾‚·‚éB
 *
 * \param tray_id —Dæ‹‹†ƒgƒŒƒCî•ñ‚Éw’è‚³‚ê‚Ä‚¢‚éƒgƒŒƒCIDB
 * di_onetrayinfo_t QÆB
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
...
/**
 * \brief Œ»İw’è‚³‚ê‚Ä‚¢‚é—Dæ”r†ƒrƒ“î•ñ‚ğæ“¾‚·‚éB
 *
 * \param bin_id —Dæ”r†ƒrƒ“î•ñ‚Éw’è‚³‚ê‚Ä‚¢‚éƒrƒ“IDB
 * di_onebininfo_t QÆB
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
 ...
 *
 * \post —Dæ”r†ƒrƒ“‚ÌID‚ª*bin_id‚ÉŠi”[‚³‚ê‚é
 */
extern EXPORT int di_get_defbin( int *bin_id );

/**
 * \brief ”r†ƒrƒ“î•ñ‚Ìæ“¾‚ğs‚¤B
 *
 * \param bininfo ”r†ƒrƒ“î•ñ
 *
 * \retval 0     ³íI—¹
 * \retval 0ˆÈŠO ƒGƒ‰[
 *
 ...
 *
 * \post *bininfo ‚Ì’l‚Æ”r†ƒrƒ“‚Ìî•ñ‚ªˆê’v‚·‚éB
 */
extern EXPORT int di_get_bininfo( di_bininfo_t *bininfo );

/**
 * \brief ƒvƒŠƒ“ƒ^‚ÌƒXƒe[ƒ^ƒXî•ñ‚ğæ“¾‚·‚éB
 *
...
/**
 * \brief ƒg[ƒ^ƒ‹ƒJƒEƒ“ƒ^[‚Ì’l‚ğæ“¾‚·‚éB
 *
...
/**
 * \brief EhterTalk ƒpƒ‰ƒ[ƒ^‚ğæ“¾‚·‚éB
 *
...
/**
 * \brief EhterTalk ƒpƒ‰ƒ[ƒ^‚ğİ’è‚·‚éB
 *
 * \param info EtherTalk ƒpƒ‰ƒ[ƒ^
 *
 * \retval 0     ³íI—¹
 ...
 * \pre *info ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post di_get_ethertalkinfo() ‚Åæ“¾‚µ‚½Ethertalkƒpƒ‰ƒ[ƒ^‚ª *info ‚Æ“™‚µ‚­‚È‚éB
 */
extern EXPORT int di_set_ethertalkinfo( di_ethertalk_info_t *info );

/**
 * \brief ƒ†[ƒU[ƒWƒ‡ƒuî•ñ‚ğİ’è‚·‚éB
 *
 ...
 * \retval 0     ³íI—¹
 * \retval -1    ƒGƒ‰[
 * \retval -2    w’è‚µ‚½ƒpƒ‰ƒ[ƒ^‚ğƒTƒ|[ƒg‚µ‚Ä‚¢‚È‚¢
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre ƒVƒXƒeƒ€‚©‚ç’Êíˆ——v‹‚ª—ˆ‚Ä‚¢‚é
 * ( di_get_request() , di_trans_process )QÆ
 * \pre *info ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post ƒ†[ƒU[ƒWƒ‡ƒuî•ñ‚ªƒVƒXƒeƒ€‚Éİ’è‚³‚ê‚Ä‚¢‚éB
 */
extern EXPORT int di_set_ujobinfo( int job_id, di_ujob_info_t *info );

/**
 * \brief ƒ†[ƒU[ƒWƒ‡ƒuî•ñ‚ğæ“¾‚·‚éB
 *
 * \param job_id ƒ†[ƒU[ƒWƒ‡ƒuID
 * \param info   ƒ†[ƒU[ƒWƒ‡ƒuî•ñ
 *
 ...
 * \pre *info ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post *info‚Ì‹¤—p‘Ìup‚ÉŒ»İİ’è‚³‚ê‚Ä‚¢‚é’l‚ª“ü‚éB
 * \post İ’è‚³‚ê‚Ä‚¢‚È‚¢ê‡‚É‚Íinfo->flag‚É‚Äw’è‚³‚ê‚½ƒtƒ‰ƒO‚ªƒŠƒZƒbƒg‚³‚ê‚éB
 */
extern EXPORT int di_get_ujobinfo( int job_id, di_ujob_info_t *info );

/**
 * \brief ƒrƒbƒgƒXƒCƒbƒ`‚Ì’l‚ğæ“¾‚·‚éB
 *
...
/**
 * ŠeíƒfƒBƒXƒNî•ñ‚ğæ“¾‚·‚éB
 *
 * \param type ƒfƒBƒXƒN‚Ìí—Ş
 *  <table>
 *   <tr>
 *    <td><center>’l</center></td><td><center>“à—e</center></td>
 *   </tr>
 ...
 * \retval -3 ó•t‹‘”ÛiŒÄ‚Ño‚µ‚Ì“ñd‰»‚ª”­¶‚µ‚½ê‡j
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre type ‚ªˆø”‚Ìà–¾‚É‚ ‚é’l‚Ì‚¢‚¸‚ê‚©
 * \pre *val ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post type ‚Åw’è‚³‚ê‚½ƒfƒBƒXƒNî•ñ’l‚ª *info ‚Æ“™‚µ‚­‚È‚éB
 */
extern EXPORT int di_get_diskinfo( int type, di_diskinfo_t *info );

/**
 * \brief ƒXƒgƒŒ[ƒWƒfƒoƒCƒX‚Öƒtƒ@ƒCƒ‹‚ğ•Û‘¶‚·‚éB
 *
 * \param type ƒXƒgƒŒ[ƒW‚Ìí—Ş
 *  <table>
 *   <tr>
 *    <td><center>’l</center></td><td><center>“à—e</center></td>
 *   </tr>
 ...
 *   </tr>
 *  </table>
 * \param fname ‚S•¶š‚Ìƒtƒ@ƒCƒ‹–¼
 * \param data  ‘‚«‚Şƒf[ƒ^”z—ñ‚Ìæ“ªƒAƒhƒŒƒX
 * \param size  data‚Ì”z—ñ‚Ì’·‚³
 *
 * \retval  0 ³íI—¹
 * \retval -1 ƒGƒ‰[
 * \retval -2 —e—Ê•s‘«‚É‚æ‚é¸”s
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre type ‚ªˆø”‚Ìà–¾‚É‚ ‚é’l‚Ì‚¢‚¸‚ê‚©
 * \pre *fname ‚Åw’è‚·‚éƒtƒ@ƒCƒ‹–¼‚ª‚S•¶š
...
/**
 * \brief ƒXƒgƒŒ[ƒWƒfƒoƒCƒX‚É‘‚«‚Ü‚ê‚Ä‚¢‚éƒtƒ@ƒCƒ‹‚©‚çƒf[ƒ^‚ğ“Ç‚İ
 *‚ŞB
 *
 * \param type    ƒXƒgƒŒ[ƒW‚Ìí—Ş(“à—e‚Í di_write_storage() ‚Æ“¯‚¶)
 * \param fname   ‚S•¶š‚Ìƒtƒ@ƒCƒ‹–¼
 * \param data    “Ç‚İ‚ñ‚¾ƒf[ƒ^‚ğŠi”[‚·‚é”z—ñ‚Ìæ“ªƒAƒhƒŒƒX
 * \param size    data‚Ì”z—ñ‚Ì’·‚³
 * \param data_size ÀÛ‚É“Ç‚ñ‚¾ƒf[ƒ^‚ÌƒTƒCƒY
 *
 * \retval  0 ³íI—¹
 * \retval -1 ƒGƒ‰[
 * \retval -2 fname ‚Æ‚¢‚¤ƒtƒ@ƒCƒ‹‚ª‘¶İ‚µ‚È‚¢
 * \retval -3 data[size]‚æ‚è‘å‚«‚¢ƒtƒ@ƒCƒ‹‚¾‚Á‚½‚Ì‚ÅÅŒã‚Ü‚Å“Ç‚İ‚ß‚È
 *‚©‚Á‚½B‚±‚Ìê‡‚Å‚àsize•ª‚¾‚¯‚Ídata[]‚É“Ç‚İ‚Ü‚êA*data_size‚ÉƒRƒs
...
/**
 * \brief ƒXƒgƒŒ[ƒWƒfƒoƒCƒX‚É‘‚«‚Ü‚ê‚Ä‚¢‚éƒtƒ@ƒCƒ‹‚ğíœ‚·‚éB
 *
 * \param type  ƒXƒgƒŒ[ƒW‚Ìí—Ş(“à—e‚Í di_write_storage() ‚Æ“¯‚¶)
 * \param fname ‚S•¶š‚Ìƒtƒ@ƒCƒ‹–¼
 *
 ...
 * \pre *fname ‚Åw’è‚·‚éƒtƒ@ƒCƒ‹–¼‚ª‚S•¶š
 *
 * \post ƒXƒgƒŒ[ƒW‚É fname ‚Æ‚¢‚¤ƒtƒ@ƒCƒ‹‚ª‘¶İ‚µ‚È‚¢B
 */
extern EXPORT int di_delete_storage( int type, char *fname );

/**
 * \brief ğŒ‚É‡’v‚·‚éw’è—p†‚ğ—v‹‚·‚é
 *
 * \param plotid  ƒvƒƒbƒ^ID
 * \param psize   —p†ƒTƒCƒYID
 * \param nodir   —p†•ûŒü
 *  <table>
 *   <tr>
 *    <td><center>’l</center></td><td><center>“à—e</center></td>
 ...
 *   <tr>
 *    <td>0</td>
 *    <td>—p†ƒTƒCƒY‚Åw’è‚µ‚½•ûŒü‚Ì‚İB</td>
 *   </tr>
 *   <tr>
 *    <td>1</td>
 *    <td>—p†ƒTƒCƒY‚ªˆÙ‚È‚é•ûŒü‚Å‚à‚n‚jB</td>
 *   </tr>
 *  </table>
 * \param ptype   †í
 ...
 * \param req     —v‹Œ‹‰Ê
 *
 * \retval  4 ƒTƒuƒy[ƒp[ƒTƒCƒY‚ª—LŒø‚Ì‚Æ‚«A—v‹—p†ƒTƒCƒY‚Æ—Ş—‚µ‚½
 *ƒTƒCƒY‚Ì—p†‚ªoŒ»‚µ‚½
 * \retval  3 ƒGƒ‰[‰æ–Ê‚É‚¨‚¯‚éƒ†[ƒU[‚Ì‘€ì‚É‚æ‚èA‹­§ˆóü‚ª‘I‘ğ‚³
 *‚ê‚½
 * \retval  2 ƒGƒ‰[‰æ–Ê‚É‚¨‚¯‚éƒ†[ƒU[‚Ì‘€ì‚É‚æ‚èAƒWƒ‡ƒuƒLƒƒƒ“ƒZƒ‹
 *‚ª‘I‘ğ‚³‚ê‚½
 * \retval  1 ƒGƒ‰[ƒXƒLƒbƒv‚ª”­¶‚µ‚½
 * \retval  0 ğŒ‚Éˆê’v‚·‚é—p†‚ªoŒ»‚µ‚½
 * \retval -1 ƒGƒ‰[
 * \retval -2 ƒrƒW[iƒI[ƒvƒ“Ï‚İƒy[ƒW‚Ìˆóü‚ªI—¹‚µ‚Ä‚¢‚È‚¢j
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre *req ‚ªƒAƒNƒZƒX‰Â”\
 *
...
/**
 * \brief ŠÂ‹«•Ï”‚ÌƒfƒtƒHƒ‹ƒg’l‚ğæ“¾‚·‚éB
 *
 * \param table_name  ŠÂ‹«•Ï”ƒe[ƒuƒ‹–¼
 * \param id          ŠÂ‹«•Ï”ID
 * \param val         “¾‚ç‚ê‚½ŠÂ‹«•Ï”‚Ì’l
 ...
 * \retval  0 ³íI—¹
 * \retval -1 ƒGƒ‰[
 * \retval -2 table_name‚ª‘¶İ‚µ‚È‚¢
 * \retval -3 w’è‚µ‚½ŠÂ‹«•Ï”‚ª‚È‚¢
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre table_name ‚Æ‚¢‚¤ƒe[ƒuƒ‹‚ª‘¶İ‚·‚éB
 * \pre ŠÂ‹«•Ï” id ‚ªAtable_name ‚É‘¶İ‚·‚éB
 ...
 * \retval -5 val‚ªİ’è•s‰Â”\‚È’l
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre table_name ‚Æ‚¢‚¤ƒe[ƒuƒ‹‚ª‘¶İ‚·‚éB
 * \pre ŠÂ‹«•Ï” id ‚ªAtable_name ‚É‘¶İ‚·‚éB
 * \pre ŠÂ‹«•Ï” id ‚ªAtable_name ‚Éİ’è‰Â”\‚Å‚ ‚éB
 *
 * \post val ‚ªŠÂ‹«•Ï” id ‚ÌƒfƒtƒHƒ‹ƒg’l‚Æ“™‚µ‚­‚È‚éB
 */
...
/**
 * \brief ŠÂ‹«•Ï”‚Ì’lƒŠƒXƒg‚Ìæ“¾
 *
 * \param table_name  ŠÂ‹«•Ï”ƒe[ƒuƒ‹–¼
 * \param id          ŠÂ‹«•Ï”ID
 * \param start       æ“¾‚µ‚½‚¢ŠÂ‹«•Ï”‚Ì’l‚ÌƒŠƒXƒg’†‚Ìæ“ª”Ô†
 * \param end         æ“¾‚µ‚½‚¢ŠÂ‹«•Ï”‚Ì’l‚ÌƒŠƒXƒg’†‚ÌI—¹”Ô†
 * \param list        ’l‚ÌƒŠƒXƒg‚ğ“ü‚ê‚é”z—ñ‚Ìƒ|ƒCƒ“ƒ^
...
/**
 * \brief ƒpƒlƒ‹•\¦Œ¾Œê‚ğæ“¾‚·‚éB
 *
 * \param language   ƒpƒlƒ‹•\¦Œ¾Œê
 *
 * \retval  0 ³íI—¹
 * \retval -1 ƒGƒ‰[
 *
 ...
 * \pre *table_name ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post *language ‚ªƒpƒlƒ‹•\¦Œ¾Œê‚Æ“™‚µ‚­‚È‚éB
 */
extern EXPORT int di_get_panellang(unsigned char *language);

/**
 * \brief “‹Ú‚³‚ê‚Ä‚¢‚éƒtƒ‰ƒbƒVƒ…ƒƒ‚ƒŠ‚ÌŠeíî•ñ‚ğæ“¾‚·‚éB
 *
 ...
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 * \pre *info ‚ªƒAƒNƒZƒX‰Â”\
 * \pre id ‚ª 1`n ‚Ì”ÍˆÍ“àBn ‚Í di_get_flashmemnum() ‚Åæ“¾‚³‚ê‚é
...
/**
 * \brief “‹Ú‚³‚ê‚Ä‚¢‚éƒtƒ‰ƒbƒVƒ…ƒƒ‚ƒŠ‚Ì”‚ğæ“¾‚·‚éB
 *
...
/**
 * \brief ’Ê†‰Â”\‚ÈÅ‘å—p†ƒTƒCƒY‚ğæ“¾‚·‚éB
 *
 * \param x     å‘–¸•ûŒü(’PˆÊ : 1/10mm)
 ...
 * \pre *y ‚ªƒAƒNƒZƒX‰Â”\
 *
 * \post *x ‚ªå‘–¸•ûŒü‚Ì’Ê†‰Â”\Å‘åƒTƒCƒY‚Æ“™‚µ‚­‚È‚éB
 * \post *y ‚ª•›‘–¸•ûŒü‚Ì’Ê†‰Â”\Å‘åƒTƒCƒY‚Æ“™‚µ‚­‚È‚éB
 */
extern EXPORT int di_get_maxpapersize(long *x, long *y);

/**
 * \brief ƒGƒ“ƒWƒ“‚Åì‘œ‰Â”\‚ÈÅ‘åƒTƒCƒY‚ğæ“¾‚·‚éB
 *
 * \param x     å‘–¸•ûŒü(’PˆÊ : 1/10mm)
 * \param y     •›‘–¸•ûŒü(’PˆÊ : 1/10mm)
 *
 ...
 * \param buf       ƒƒjƒ…[ƒAƒCƒeƒ€‚Ìî•ñ‚ğŠi”[‚·‚éƒoƒbƒtƒ@
 *
 * \retval  0 ³íI—¹
 * \retval -1 ƒGƒ‰[
 *
...
/**
 * \brief w’è‚·‚éƒfƒoƒCƒX‚©‚ç•¶š—ñ‚ğæ“¾‚·‚éB
 *
 * \param type    ƒfƒoƒCƒXí—Ş
 * \param device  ƒfƒoƒCƒX‚ÌÚ×
 * \param id      •¶š—ñID
 * \param buf     •¶š—ñ‚ğŠi”[‚·‚éƒoƒbƒtƒ@
 * \param size    I’[•¶š‚ğŠÜ‚ñ‚¾•¶š—ñ‚Ì’·‚³
 *
 * \retval  0 ³íI—¹
 * \retval -1 ƒGƒ‰[
 *
 ...
 *
 * \post buf ‚ªw’è‚³‚ê‚½ƒfƒoƒCƒX‚Ì•¶š—ñ‚Æ“™‚µ‚­‚È‚éB
 */
extern EXPORT int di_get_string(int type, long device, unsigned long id,
								unsigned char *buf, unsigned long size);
								
/**
 * \brief ƒtƒHƒ“ƒg‚Ìî•ñ‚ğæ“¾‚·‚éB
 *
 * ƒtƒHƒ“ƒg‚ÌŠî–{î•ñ‚Í di_getinfo() ‚Åæ“¾‚Å‚«‚é‚ªAÚ×î•ñ‚ğæ“¾‚·
 *‚éê‡A‚à‚µ‚­‚Í di_getinfo() ‚Åæ“¾‚Å‚«‚éƒtƒHƒ“ƒgˆÈŠO‚Ìí—Ş‚ÌƒtƒHƒ“
 *ƒgî•ñ‚ğæ“¾‚·‚éê‡‚É–{ŠÖ”‚ğg—p‚·‚éB
 *
 * \param type  ƒtƒHƒ“ƒg‚Ìí—Ş
...
/**
 * \brief ƒ†[ƒU[ƒWƒ‡ƒu•Ï”‚Ì’l‚ğæ“¾‚·‚éB
 *
 * \param ujobparam ƒ†[ƒU[ƒWƒ‡ƒuî•ñ
 *
 * \retval  0 ³íI—¹
 * \retval -1 ƒWƒ‡ƒuID‚ª–³Œø
 * \retval -2 ƒTƒ|[ƒg‚µ‚Ä‚¢‚È‚¢ƒpƒ‰ƒ[ƒ^‚ğw’è‚µ‚½
 *
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
...
/**
 * \brief w’è‚³‚ê‚½—p†“™‚Ìî•ñ‚ğŒ³‚ÉA•K—v‚È‰æ‘œ‰ñ“]•ûŒü‚Ìî•ñ‚ğæ“¾
 *‚·‚éB
 *
 * \param plotid ƒvƒƒbƒ^ID
 * \param info   ‰æ‘œ‰ñ“]•ûŒü‚Ì”»’è‚ğs‚¤‚½‚ß‚Ìî•ñ
 ...
 * \pre di_init() ‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚éB
 *
 * \post ƒVƒXƒeƒ€“à‚ÌƒKƒ“ƒ}‚ªÄŒvZ‚³‚ê‚éB
 */
extern EXPORT int di_update_gamma();

/**
 * \brief ŠÂ‹«•Ï”‚Ì’l(ƒoƒCƒg—ñ)‚ğæ“¾‚·‚éB
 *
 * \param table_name ŠÂ‹«•Ï”ƒe[ƒuƒ‹–¼
 * \param id         ŠÂ‹«•Ï”ID
 * \param val        “¾‚ç‚ê‚½ŠÂ‹«•Ï”‚Ì’l
 * \param in_size    ƒoƒCƒg—ñval‚ÌƒoƒCƒg”BŠÂ‹«•Ï”‚ª•¶š—ñ‚Ìê‡‚É‚ÍANULLƒ^[ƒ~ƒl[ƒg‚ª“ü‚é‚¾‚¯‚Ì”‚ğw’è‚·‚é‚±‚ÆB
 * \param out_size   ƒoƒCƒg—ñ‚Ì—LŒø‚ÈƒoƒCƒg”BŠÂ‹«•Ï”‚ª•¶š—ñ‚Ìê‡‚É‚ÍANULLƒ^[ƒ~ƒl[ƒg‚ğŠÜ‚Ş’·‚³‚ğ•Ô‚·B
 *
 * \retval  1 ³íI—¹iŠÂ‹«•Ï”‚ª–¾¦“I‚Éw’è‚³‚ê‚Ä‚¢‚éj
 * \retval  0 ³íI—¹iŠÂ‹«•Ï”‚ª–¾¦“I‚Éw’è‚³‚ê‚Ä‚È‚¢‚½‚ßAƒfƒtƒHƒ‹
 *ƒg’lƒZƒbƒg)
 * \retval -1 ƒGƒ‰[idi_init()‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚È‚¢AŠÖ”‚ğƒTƒ|[ƒg‚µ‚Ä‚¢‚È‚¢j
 * \retval -2 ƒGƒ‰[itable_name‚ª‘¶İ‚µ‚È‚¢j
 * \retval -3 ƒGƒ‰[iw’è‚µ‚½ŠÂ‹«•Ï”‚ª‚È‚¢j
 ...
 * \pre di_init()‚ªƒR[ƒ‹‚³‚ê‚Ä‚¢‚é
 * \pre str‚ªNULL‚Å‚È‚¢
 * \pre str‚ªNULLƒ^[ƒ~ƒl[ƒg‚ğŠÜ‚ß‚ÄA8ƒoƒCƒgˆÈ“à‚Å‚ ‚é
 *
 * \post ƒpƒlƒ‹‚Éstr‚Åw’è‚µ‚½ƒGƒ~ƒ…ƒŒ[ƒVƒ‡ƒ“–¼‚ª•\¦‚³‚ê‚é(GPS“®ì‚Ì‚İ)
 */
