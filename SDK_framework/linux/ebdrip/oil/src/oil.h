...
//revisit
...
#endif
	OIL_eColorMode  eColorMode;              /**< 1=Mono; 2=SeparationsColor; 3=SeparationsAuto; 4=CompositeColor; 5=CompositeAuto */
	...
	int 			nRasterWidthBits;        /**< Bits in a scan line (even in multiple bits per pixel
                                                  ...
                                                  */
	char            szJobName[OIL_MAX_JOBNAME_LENGTH]; /**< The name of the job. */											  
...
typedef struct tyJob
{
	...
	unsigned int    uPrintBannerPage;     /**< Print Banner page selected  0, 1 or 2*/
    BOOL            bBannerPagesComplete;  /**< Banner Page  printed */
#endif
	unsigned int	 uBindingType; /*To get the Binding type selected*/
