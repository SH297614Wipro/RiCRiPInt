...
#define EBD_SYS_HWARENDER   EBD_SYS_HDDPDFSPOOLDIR+1
  {
    "Sys_HWARender", 0,    PARAM_READONLY | PARAM_SET,
    ParamBoolean, &g_tSystemInfo.bHWA,  0, 1
  }
};
...
static void SetJobParams() {
  ...
  switch(g_pstCurrentJob->ePDLType)
  {
    ...
    case OIL_PDL_PCL5c:
    case OIL_PDL_PCLXL:
      stEBDDeviceParams.nJobPDL = g_pstCurrentJob->ePDLType;
    break;
