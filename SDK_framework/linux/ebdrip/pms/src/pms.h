...
#if !defined(_PPC_) && (defined(WIN32) || defined(linux) || defined(CPU_ARM9) || defined(__NetBSD__))
#define PMS_LOWBYTEFIRST
...
extern int HWA_FPGA_FileHandler(unsigned char *orderlist, size_t orderlen, unsigned char *assets, size_t assetlen, int complete, int index);
