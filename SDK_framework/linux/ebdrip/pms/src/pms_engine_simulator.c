...
int EngineGetTrayInfo(void)
{
  ...
  */
  ...
  {
    g_pstTrayInfo[nTrayIndex].eMediaSource = PMS_TRAY_MAN;
    ...
    g_pstTrayInfo[nTrayIndex].ePaperSize = PMS_SIZE_A4T;
    g_pstTrayInfo[nTrayIndex].eMediaType = PMS_TYPE_DONT_KNOW;
    g_pstTrayInfo[nTrayIndex].eMediaColor = PMS_COLOR_DONT_KNOW;
    g_pstTrayInfo[nTrayIndex].uMediaWeight = 0;
    ...
    g_pstTrayInfo[nTrayIndex].ePaperSize = PMS_SIZE_8Hx11;
    g_pstTrayInfo[nTrayIndex].eMediaType = PMS_TYPE_DONT_KNOW;
    g_pstTrayInfo[nTrayIndex].eMediaColor = PMS_COLOR_DONT_KNOW;
    g_pstTrayInfo[nTrayIndex].uMediaWeight = 0;
...
g_tJob.tCurrentJobMedia.dHeight = pPaperInfo->dHeight;
  ...
  g_tJob.uSymbolSet = 341;        /* 10U - PC 8 */
