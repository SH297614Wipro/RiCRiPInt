...
#include "pms_ff.h"
 ...
 extern int job_seperation; //To get the PDL job seperation data
 extern unsigned int g_JobEnd,g_JobStart;
 extern OIL_TyPage *g_pstCurrentPage; 
 extern int ProcessAllPages,PrintUptoLastPage,StopPrinting;
 int PageCount;
 extern int print_force_flag;
...
extern const unsigned char *g_hwa1_gamma_data;
extern const unsigned int g_hwa1_gamma_len;
...
extern const unsigned int g_hwa1_cell_len_2bpp [4];
#ifdef DEFAULT_PDL
extern const unsigned int *g_tec_basic_data[2];
extern const unsigned int g_tec_basic_data_len[2];
#endif
extern int paper_type_slip;
extern int mode_chapter;
extern int chapter_val;

/* PMS_WriteStdOut output method. */
extern int g_nPMSStdOutMethod;
extern void *g_semTaggedOutput;
extern int GPS_FrameChapterSet( gwmsg_client_t* client, int frameid, unsigned char mode, unsigned char paper_type );
extern int GPS_FramePrintInfo(gwmsg_client_t *client, int FP_frameid, const gps_pageinfo2_t *pageinfo2, unsigned long *FP_flag);
extern int GPS_FramePrint(gwmsg_client_t *client, int FP_frameid, const gps_pageinfo_t *pageinfo, int FP_force);
extern int GPS_FrameClose(gwmsg_client_t *client, int FP_frameid);
...
#ifdef DEFAULT_PDL
/* TEC Level sent rom display list code */
static int CurrentTECLevel;
#endif
...
static PMS_TyPaperInfo l_apPapers[] = {
  /* Portrait feed sizes */
  { PMS_SIZE_8Hx11,     612.00,  792.00, "LETTER",
    UNPRINTABLE, LOGICALPAGE75PX,
    PMS_PCL5_LETTER, PMS_PCLX_LETTER,
    "/Letter", "(LETTER)"},
  { PMS_SIZE_A4,         595.20,  841.68, "A4",
    ...
    PMS_PCL5_A4, PMS_PCLX_A4,
    "/A4", "(A4)"},
  { PMS_SIZE_8Hx14,      612.00, 1008.00, "LEGAL",
    UNPRINTABLE, LOGICALPAGE75PX,
    PMS_PCL5_LEGAL, PMS_PCLX_LEGAL,
    "/Legal", "(LEGAL)"},
  { PMS_SIZE_7Qx10H,        522.00,  756.00, "EXE",
    UNPRINTABLE, LOGICALPAGE75PX,
    PMS_PCL5_EXE, PMS_PCLX_EXE,
    "/Executive", "(EXEC)"},
  { PMS_SIZE_A3,         841.68, 1190.40, "A3",
    ...
    PMS_PCL5_A3, PMS_PCLX_A3,
    "/A3", "(A3)"},
  { PMS_SIZE_11x17,    792.00, 1224.00, "TABLOID",
    UNPRINTABLE, LOGICALPAGE75PX,
    PMS_PCL5_TABLOID, PMS_PCLX_TABLOID,
    "/Tabloid", "(TABLOID)"},
  { PMS_SIZE_A5,         420.96,  595.20, "A5",
  ...
  { PMS_SIZE_A6,         298.00,  420.00, "A6",
    ...
    PMS_PCL5_A6, PMS_PCLX_A6,
    "/A6", "(A6)"},
  { PMS_SIZE_C5,     459.21,  649.13, "C5_ENV",
    UNPRINTABLE, LOGICALPAGE71PX,
    PMS_PCL5_C5_ENV, PMS_PCLX_C5_ENV,
    "/C5", "(C5)"},
  { PMS_SIZE_DL,     311.81,  623.62, "DL_ENV",
    UNPRINTABLE, LOGICALPAGE71PX,
    PMS_PCL5_DL_ENV, PMS_PCLX_DL_ENV,
    "/DL", "(DL)"},
  { PMS_SIZE_LEDGER,    1224.00,  792.00, "LEDGER",
  ...
  { PMS_SIZE_OFUKU,     419.53,   566.93, "OFUKU",
    ...
    PMS_PCL5_OFUKU, PMS_PCLX_OFUKU,
    "/Ofuku", "(OFUKU)"},
  { PMS_SIZE_10x14,     727.20, 1029.60, "JISB4",
    UNPRINTABLE, LOGICALPAGE59PX,
    PMS_PCL5_JISB4, PMS_PCLX_JISB4,
    "/JISB4", "(JIS B4)"},
  { PMS_SIZE_JISB5,     518.40, 727.20, "JISB5",
    ...
    "/JISB5", "(JIS B5)"},
    /* Landscape feed sizes */
  { PMS_SIZE_8Hx11T,   792.00,  612.00, "LETTER_R",
    UNPRINTABLE, LOGICALPAGE60PX,
    PMS_PCL5_LETTER, PMS_PCLX_LETTER,
    "/Letter", "(LETTER)"},
  { PMS_SIZE_A4T,       841.68,  595.20, "A4_R",
    UNPRINTABLE, LOGICALPAGE59PX,
    PMS_PCL5_A4, PMS_PCLX_A4,
    "/A4", "(A4)"},
  { PMS_SIZE_8Hx14T,   1008.00,  612.00, "LEGAL_R",
    UNPRINTABLE, LOGICALPAGE60PX,
    PMS_PCL5_LEGAL, PMS_PCLX_LEGAL,
    "/Legal", "(LEGAL)"},
  { PMS_SIZE_7Qx10HT,      756.00,  522.00, "EXE_R",
    UNPRINTABLE, LOGICALPAGE60PX,
    PMS_PCL5_EXE, PMS_PCLX_EXE,
    "/Executive", "(EXEC)"},
  { PMS_SIZE_A3T,      1190.40,  841.68, "A3_R",
    UNPRINTABLE, LOGICALPAGE59PX,
    PMS_PCL5_A3, PMS_PCLX_A3,
    "/A3", "(A3)"},
  { PMS_SIZE_11x17T, 1224.00,  792.00, "TABLOID_R",
    UNPRINTABLE, LOGICALPAGE60PX,
    PMS_PCL5_TABLOID, PMS_PCLX_TABLOID,
    "/Tabloid", "(TABLOID)"},
  { PMS_SIZE_A5T,       595.20,  420.00, "A5_R",
    UNPRINTABLE, LOGICALPAGE59PX,
    PMS_PCL5_A5, PMS_PCLX_A5,
    "/A5", "(A5)"},
  { PMS_SIZE_A6T,       420.00,  298.00, "A6_R",
    UNPRINTABLE, LOGICALPAGE59PX,
    PMS_PCL5_A6, PMS_PCLX_A6,
    "/A6", "(A6)"},
  { PMS_SIZE_C5T,   649.13,  459.21, "C5_ENV_R",
    UNPRINTABLE, LOGICALPAGE59PX,
    PMS_PCL5_C5_ENV, PMS_PCLX_C5_ENV,
    "/C5", "(C5)"},
  { PMS_SIZE_DL_T,   623.62,  311.81, "DL_ENV_R",
    UNPRINTABLE, LOGICALPAGE59PX,
    PMS_PCL5_DL_ENV, PMS_PCLX_DL_ENV,
    "/DL", "(DL)"},
  { PMS_SIZE_LEDGER_R,   792.00, 1224.00, "LEDGER_R",
  ...
  { PMS_SIZE_OFUKU_R,    566.93,  419.53, "OFUKU_R",
    ...
    PMS_PCL5_OFUKU, PMS_PCLX_OFUKU,
    "/Ofuku", "(OFUKU)"},
  { PMS_SIZE_10x14T,    1029.60,  727.20, "JISB4_R",
    UNPRINTABLE, LOGICALPAGE59PX,
    PMS_PCL5_JISB4, PMS_PCLX_JISB4,
    "/JISB4", "(JIS B4)"},
  { PMS_SIZE_JISB5_R,    727.20,  518.40, "JISB5_R",
...
#endif
static PMS_TyMediaType l_apMediaType[] = {
  { PMS_TYPE_NORMAL,"Plain","PLAIN",                       /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_PLAIN, "Plain", "Plain"},                /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_BOND,"Bond","BOND",                          /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_BOND, "Bond", "Bond"},                   /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_SPECIAL,"Special","SPECIAL",                 /** PMS value, PS string, PJL string **/
  ...
  { PMS_TYPE_GLOSSY,"Glossy","GLOSSY",                    /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_GLOSSY, "Glossy", "Glossy"},             /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_OHP,"Transparency","TRANSPARENCY",  /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_TRANSPARENCY, "Transparency", "Transparency"},  /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_RECYCLE,"Recycled","RECYCLED",              /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_RECYCLED, "Recycled", "Recycled"},       /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_MIDDLETHICK,"Thick","THICK",                       /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_THICK, "Thick", "Thick"},                /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_ENVELOPE,"Envelope","ENVELOPE",              /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_ENVELOPE, "Envelope", "Envelope"},       /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_POSTCARD,"Postcard","POSTCARD",              /** PMS value, PS string, PJL string **/
  ...
  { PMS_TYPE_LABEL,"Label","LABEL",                       /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_LABEL, "Label", "Label"},                /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_PREPRINT,"Preprinted","PREPRINTED",        /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_PREPRINTED, "Preprinted", "Preprinted"}, /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_LETTER_HEAD,"Letterhead","LETTERHEAD",        /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_LETTERHEAD, "Letterhead", "Letterhead"}, /** PCL5 value, PCL5 string, PCLXL string **/
  { PMS_TYPE_DONT_KNOW,"","",                             /** PMS value, PS string, PJL string **/
    PMS_PCL5TYPE_DONT_KNOW, "", ""},                      /** PCL5 value, PCL5 string, PCLXL string **/
};
...
static PMS_TyMediaSource l_apMediaSource[] = {
  ...
  { PMS_TRAY_MAN, PMS_PSTRAY_MANUALFEED, "MANUALFEED", /** PMS value, PS value, PJL string **/
  ...
  { PMS_TRAY_TRAY4, PMS_PSTRAY_TRAY4, "TRAY4",                /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_TRAY4, PMS_PCLXTRAY_TRAY4},                  /** PCL5 value, PCLXL value **/
  { PMS_TRAY_TRAY5, PMS_PSTRAY_TRAY5, "TRAY5",                /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_TRAY5, PMS_PCLXTRAY_TRAY5},                  /** PCL5 value, PCLXL value **/
  { PMS_TRAY_TRAY6, PMS_PSTRAY_TRAY6, "TRAY6",                /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_TRAY6, PMS_PCLXTRAY_TRAY6},                  /** PCL5 value, PCLXL value **/
  { PMS_TRAY_TRAY7, PMS_PSTRAY_TRAY7, "TRAY7",                /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_TRAY7, PMS_PCLXTRAY_TRAY7},                  /** PCL5 value, PCLXL value **/
  { PMS_TRAY_LCT, PMS_PSTRAY_LCT, "LCT",                      /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_LCT, PMS_PCLXTRAY_LCT},                      /** PCL5 value, PCLXL value **/
  { PMS_TRAY_INSERTER, PMS_PSTRAY_INSERTER, "INSERTER",                      /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_INSERTER, PMS_PCLXTRAY_INSERTER2},                          /** PCL5 value, PCLXL value **/
  { PMS_TRAY_INSERTER2, PMS_PSTRAY_INSERTER2, "INSERTER2",                   /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_INSERTER2, PMS_PCLXTRAY_INSERTER2},                         /** PCL5 value, PCLXL value **/
  { PMS_TRAY_PERF_INSERTER, PMS_PSTRAY_PERF_INSERTER, "PERFINSERTER",        /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_PERF_INSERTER, PMS_PCLXTRAY_PERF_INSERTER},                 /** PCL5 value, PCLXL value **/
  { PMS_TRAY_PERF_INSERTER2, PMS_PSTRAY_PERF_INSERTER2, "PERFINSERTER2",     /** PMS value, PS value, PJL string **/
    PMS_PCL5TRAY_PERF_INSERTER2, PMS_PCLXTRAY_PERF_INSERTER2},               /** PCL5 value, PCLXL value **/
...
unsigned long FP_flag;
...
#ifdef DEFAULT_PDL
  char szTECLevel[3][18] = {"TEC Level Two \n", "TEC Level One \n", "TEC Level Normal\n"};
#endif
  ...
  if(ThisBand == NULL) /* last band */
  {
	...
	/* No RIP ahead, output the page and signal pagedone before returning */
#ifdef DEFAULT_PDL
        pstPageToPrint->uTECValue = CurrentTECLevel;
        OIL_OutputTECValue(szTECLevel[CurrentTECLevel]);
        printf("\n Fuser temperature for this page, pstPageToPrint->uTECValue = %s", szTECLevel[CurrentTECLevel]);

	switch(pstPageToPrint->uTECValue)
	{
	    case TECVALUETWO:
	        pageinfo2.fuser_ctl = GPS_FUSER_CTL_LEVEL2;
	        break;
	    case TECVALUEONE:
	        pageinfo2.fuser_ctl = GPS_FUSER_CTL_LEVEL1;
	        break;
	    case TECVALUENORMAL:
	        pageinfo2.fuser_ctl = GPS_FUSER_CTL_STD;
            default:
    	        break;
	...
	if((!StopPrinting) && /* stop printing all pages if jobstart value is greater than jobend*/
	(((g_pstCurrentPage->uPageNo >=g_JobStart)&& (g_pstCurrentPage->uPageNo <=g_JobEnd))||/*process the pages 			within the job start and job end */
	(ProcessAllPages ==1) || /* process all pages if job start and job end values are less than 1 */
	((g_pstCurrentPage->uPageNo >=g_JobStart)&& (PrintUptoLastPage == 1))))/*process pages from job start to last page if 		job start is positive value and job end is negative*/

	{

	if((ProcessAllPages ==0) && (g_pstCurrentPage->uPageNo == g_JobEnd))
	{
...
if(chapter_val == TRUE)
{
    GPSFrameChapterSetretval = GPS_FrameChapterSet( gps_client, gps_frameid, mode_chapter, paper_type_slip);

	if(GPSFrameChapterSetretval)
	 {
		printf("GPSFrameChapterSetretval : Success\n");
	 }
	 else
	 {
		printf("GPSFrameChapterSetretval : Failed\n");
	 }
}
	 ...
	 FP_force = print_force_flag ? GPS_PRINT_FORCE : GPS_PRINT_NORMAL;
		if(FP_force==GPS_PRINT_FORCE)
		{
#ifdef DEBUG_LOGS
            		printf("\n Did not find any matching tray... Forced to take TRAY1......\n");
#endif
		}	 
...
int PMS_GetResource(int eResourceType, int index, PMS_TyResource * pResource)
{
  ...
  /* For all the HWA1 definitions only a non-NULL return from OIL is a success
   * result and will lead to an RDR definition - there's no point registering
   * NULL pointers. */
  case EPMS_HWA1_API:
        pResource->pData = (unsigned char *)OIL_HWA1_GIPA2_Interface(&(pResource->length));
        pResource->id = 20140721; /* HWA1 API version number */
        pResource->ePriority = EPMS_Priority_Normal;
        result = (pResource->pData) ? (index > 0) : -1;
        break;
  /* For the HWA1 tables we return the same table twice so it is registered
   * for both bit depths: index 0 => 1 bit, index 1 => 2 bit. */
  case EPMS_HWA1_GIPA2_CMM:             /* Rift HWA1 pointer for CMM data */
        pResource->pData = (unsigned char *)OIL_HWA1_GIPA2_CMM(&(pResource->length), NULL, 1);
        pResource->id = index + 1;
        pResource->ePriority = EPMS_Priority_Normal;
        result = (pResource->pData) ? (index > 1) : -1;
        break;
  case EPMS_HWA1_GIPA2_BLACK:           /* Rift HWA1 pointer for Balck Generation data */
        pResource->pData = (unsigned char *)OIL_HWA1_GIPA2_BGUCR(&(pResource->length), g_hwa1_bgucr_data, g_hwa1_bgucr_len);
        pResource->id = index + 1;
        pResource->ePriority = EPMS_Priority_Normal;
        result = (pResource->pData) ? (index > 1) : -1;
        break;
  case EPMS_HWA1_GIPA2_GAMMA:           /* Rift HWA1 pointer for Gamma data */
        pResource->pData = (unsigned char *)OIL_HWA1_GIPA2_Gamma(&(pResource->length), g_hwa1_gamma_data, g_hwa1_gamma_len);
        pResource->id = index + 1;
        pResource->ePriority = EPMS_Priority_Normal;
        result = (pResource->pData) ? (index > 1) : -1;
        break;
  case EPMS_HWA1_GIPA2_USER:            /* Rift HWA1 pointer for User data */
        pResource->pData = (unsigned char *)OIL_HWA1_GIPA2_User(&(pResource->length), NULL, 1);
        pResource->id = index + 1;
        pResource->ePriority = EPMS_Priority_Normal;
        result = (pResource->pData) ? (index > 1) : -1;
        break;
  case EPMS_HWA1_GIPA2_TONERLIMIT:      /* This is not a pointer - length is value */
        pResource->pData = (unsigned char *)NULL;
        pResource->length = 1020;
        pResource->id = index + 1;
        pResource->ePriority = EPMS_Priority_Normal;
        result = (index > 1);
        break;
  ...
  case EPMS_PCL5RESOURCE_API:
        if (index == 0) {
          pResource->pData = OIL_PCLResource_Interface(&pResource->length);
          pResource->id = 20140822;
          pResource->ePriority = EPMS_Priority_Normal;
        } else {
          result = -1;
        }
...
#ifdef DEFAULT_PDL
  case EPMS_TEC_API:
        pResource->pData = (unsigned char *)OIL_TEC_Interface(&(pResource->length), g_tec_basic_data[0], g_tec_basic_data_len[0]);
        pResource->id = 20140912; /* TEC API version number */
        pResource->ePriority = EPMS_Priority_Normal;
        result = (pResource->pData) ? (index > 0) : -1;
        break;
#endif
...
/* HWA 1 Functions to allow interfacing from core/oil */
int PMS_HWA1_GetBuffer(unsigned char ** pbuffer, size_t * plength)
{
  UNUSED_PARAM(unsigned char *, pbuffer);
  UNUSED_PARAM(size_t *, plength);

  return 1;
}

int PMS_HWA1_SubmitBuffer(unsigned char * orderlist, size_t orderlen,
                                      unsigned char * assets, size_t assetlen,
                                                            int complete, int index)
{
  if(g_tSystemInfo.bHWA_FPGA == TRUE)
    HWA_FPGA_FileHandler(orderlist, orderlen, assets, assetlen, complete, index);
  return 1;
}

int PMS_HWA1_DiscardBuffer(unsigned char * pbuffer) 
{
    UNUSED_PARAM(unsigned char *, pbuffer);
...
#define BANDRASTER(color,bandid) g_pstCurrentPMSPage->atPlane[color].atBand[bandid].pBandRaster
#define BANDSIZE(color,bandid) g_pstCurrentPMSPage->atPlane[color].atBand[bandid].cbBandSize

/* FPGA band base addresses - strange address order as per example files */
#define FPGA_BASE_K ((unsigned char *)0x3000000)
#define FPGA_BASE_C ((unsigned char *)0x4000000)
#define FPGA_BASE_M ((unsigned char *)0x1000000)
#define FPGA_BASE_Y ((unsigned char *)0x2000000)
...
int PMS_HWA1_GetBands(int bandid, unsigned char ** pbandC, unsigned char ** pbandM,
                                      unsigned char ** pbandY, unsigned char ** pbandK)
{
  int uBandSize ;
  
  /* Check we're not being called too early */
  if (g_pstCurrentPMSPage == 0)
    return -2 /* syntax */ ;

  /* TODO: Check max bandid too. */
  if (bandid < 0)
    return -1 /* bad band */ ;

  /* All bands are the same size */
  #ifdef PMS_OIL_MERGE_DISABLE
	uBandSize = BANDSIZE(PMS_CYAN, 0);
  #else
	uBandSize = BANDSIZE(OIL_Cyan, 0);
  #endif
  if (g_tSystemInfo.bHWA_FPGA == FALSE)
  {
    /* Allocate band buffers */
    /* TODO -- Bands should be 16 byte aligned by configuring pool appropriately */
    if (pbandK) {
#ifdef PMS_OIL_MERGE_DISABLE
      if (BANDRASTER(PMS_BLACK, bandid) == NULL)
        BANDRASTER(PMS_BLACK, bandid) = (unsigned char*)OSMalloc(uBandSize, PMS_MemoryPoolPMS);
      if (!BANDRASTER(PMS_BLACK, bandid))
        return 0 /* memory */ ;
      *pbandK = BANDRASTER(PMS_BLACK, bandid);
#else
	if (BANDRASTER(OIL_Black, bandid) == NULL)
        BANDRASTER(OIL_Black, bandid) = (unsigned char*)OSMalloc(uBandSize, PMS_MemoryPoolPMS);
      if (!BANDRASTER(OIL_Black, bandid))
        return 0 /* memory */ ;
      *pbandK = BANDRASTER(OIL_Black, bandid);
#endif
    }
#ifdef PMS_OIL_MERGE_DISABLE
    ...
    {
      if (pbandC) {
        if (BANDRASTER(PMS_CYAN, bandid) == NULL)
          BANDRASTER(PMS_CYAN, bandid) = (unsigned char*)OSMalloc(uBandSize, PMS_MemoryPoolPMS);
        if (!BANDRASTER(PMS_CYAN, bandid))
          return 0 /* memory */ ;
        *pbandC = BANDRASTER(PMS_CYAN, bandid);
      }
      if (pbandM) {
        if (BANDRASTER(PMS_MAGENTA, bandid) == NULL)
          BANDRASTER(PMS_MAGENTA, bandid) = (unsigned char*)OSMalloc(uBandSize, PMS_MemoryPoolPMS);
        if (!BANDRASTER(PMS_MAGENTA, bandid))
          return 0 /* memory */ ;
        *pbandM = BANDRASTER(PMS_MAGENTA, bandid);
      }
      if (pbandY) {
        if (BANDRASTER(PMS_YELLOW, bandid) == NULL)
          BANDRASTER(PMS_YELLOW, bandid) = (unsigned char*)OSMalloc(uBandSize, PMS_MemoryPoolPMS);
        if (!BANDRASTER(PMS_YELLOW, bandid))
          return 0 /* memory */ ;
        *pbandY = BANDRASTER(PMS_YELLOW, bandid);
      }
    }
#else
	if (g_pstCurrentPMSPage->eColorMode != OIL_Mono)
    {
      if (pbandC) {
        if (BANDRASTER(OIL_Cyan, bandid) == NULL)
          BANDRASTER(OIL_Cyan, bandid) = (unsigned char*)OSMalloc(uBandSize, PMS_MemoryPoolPMS);
        if (!BANDRASTER(OIL_Cyan, bandid))
          return 0 /* memory */ ;
        *pbandC = BANDRASTER(OIL_Cyan, bandid);
      }
      if (pbandM) {
        if (BANDRASTER(OIL_Magenta, bandid) == NULL)
          BANDRASTER(OIL_Magenta, bandid) = (unsigned char*)OSMalloc(uBandSize, PMS_MemoryPoolPMS);
        if (!BANDRASTER(OIL_Magenta, bandid))
          return 0 /* memory */ ;
        *pbandM = BANDRASTER(OIL_Magenta, bandid);
      }
      if (pbandY) {
        if (BANDRASTER(OIL_Yellow, bandid) == NULL)
          BANDRASTER(OIL_Yellow, bandid) = (unsigned char*)OSMalloc(uBandSize, PMS_MemoryPoolPMS);
        if (!BANDRASTER(OIL_Yellow, bandid))
          return 0 /* memory */ ;
        *pbandY = BANDRASTER(OIL_Yellow, bandid);
      }
    }
#endif
    else
    {
      /* If we've been given CMY pointers in gray mode, null them. */
      if (pbandC)
        *pbandC = NULL ;
      if (pbandM)
        *pbandM = NULL ;
  ...
  {
    /* FPGA addresses. */
    int offset = bandid * ((uBandSize + 15) & ~15) ;

    if (pbandK)
      *pbandK = FPGA_BASE_K + offset ;
    if (pbandC)
      *pbandC = FPGA_BASE_C + offset ;
    if (pbandM)
      *pbandM = FPGA_BASE_M + offset ;
    if (pbandY)
      *pbandY = FPGA_BASE_Y + offset ;
  }
  return 1 /* success */ ;
}

int PMS_HWA1_DiscardBands(int bandid, unsigned char * bandC, unsigned char * bandM,
                                      unsigned char * bandY, unsigned char * bandK) 
{
  if (g_tSystemInfo.bHWA_FPGA == TRUE)
  {
    /* FPGA addresses don't need freeing */
    return 1;
  }
#ifdef PMS_OIL_MERGE_DISABLE
  if ((bandK != NULL) && (BANDRASTER(PMS_BLACK, bandid) == bandK))
  {
    OSFree(bandK, PMS_MemoryPoolPMS);
    BANDRASTER(PMS_BLACK, bandid) = NULL;
  }

  if (g_pstCurrentPMSPage->eColorMode != PMS_Mono)
  {
    if ((bandC != NULL) && (BANDRASTER(PMS_CYAN, bandid) == bandC))
    {
      OSFree(bandC, PMS_MemoryPoolPMS);
      BANDRASTER(PMS_CYAN, bandid) = NULL;
    }
    if ((bandM != NULL) && (BANDRASTER(PMS_MAGENTA, bandid) == bandM))
    {
      OSFree(bandM, PMS_MemoryPoolPMS);
      BANDRASTER(PMS_MAGENTA, bandid) = NULL;
    }
    if ((bandY != NULL) && (BANDRASTER(PMS_YELLOW, bandid) == bandY))
    {
      OSFree(bandY, PMS_MemoryPoolPMS);
      BANDRASTER(PMS_YELLOW, bandid) = NULL;
    }
  }
#else
	if ((bandK != NULL) && (BANDRASTER(OIL_Black, bandid) == bandK))
  {
    OSFree(bandK, PMS_MemoryPoolPMS);
    BANDRASTER(OIL_Black, bandid) = NULL;
  }

  if (g_pstCurrentPMSPage->eColorMode != OIL_Mono)
  {
    if ((bandC != NULL) && (BANDRASTER(OIL_Cyan, bandid) == bandC))
    {
      OSFree(bandC, PMS_MemoryPoolPMS);
      BANDRASTER(OIL_Cyan, bandid) = NULL;
    }
    if ((bandM != NULL) && (BANDRASTER(OIL_Magenta, bandid) == bandM))
    {
      OSFree(bandM, PMS_MemoryPoolPMS);
      BANDRASTER(OIL_Magenta, bandid) = NULL;
    }
    if ((bandY != NULL) && (BANDRASTER(OIL_Yellow, bandid) == bandY))
    {
      OSFree(bandY, PMS_MemoryPoolPMS);
      BANDRASTER(OIL_Yellow, bandid) = NULL;
    }
  }
#endif
  return 1;
...
#ifdef DEFAULT_PDL
int PMS_SetTECLevel(int value)
{
    
  CurrentTECLevel = value;
  return 1;
}
#endif
/**
...
PMS_API_FNS PMS_InitAPI()
{
  ...
  apfnRip_IF_KcCalls[EPMS_FN_PCL5ResourceStart] = PMS_PCL5ResourceStart;
  apfnRip_IF_KcCalls[EPMS_FN_PCL5ResourceFinish] = PMS_PCL5ResourceFinish;
  apfnRip_IF_KcCalls[EPMS_FN_PCL5ResourceError] = PMS_PCL5ResourceError;
  apfnRip_IF_KcCalls[EPMS_FN_PCL5ResourceTransfer] = PMS_PCL5ResourceTransfer;
#ifdef UFST_ENABLED
  /* The following CGIF calls simply give us exposure to
     the UFST module. */
  apfnRip_IF_KcCalls[EPMS_FN_CGIFfco_Access]   = (int(*)())PMS_CGIFfco_Access;
  apfnRip_IF_KcCalls[EPMS_FN_CGIFfco_Plugin]   = (int(*)())PMS_CGIFfco_Plugin;
  ...
  apfnRip_IF_KcCalls[EPMS_FN_CGIFfco_Close]    = (int(*)())PMS_CGIFfco_Close;
  apfnRip_IF_KcCalls[EPMS_FN_CGIFmakechar]     = PMS_CGIFmakechar;
  apfnRip_IF_KcCalls[EPMS_FN_CGIFchar_size]    = (int(*)())PMS_CGIFchar_size;
  apfnRip_IF_KcCalls[EPMS_FN_CGIFfont]         = PMS_CGIFfont;
  apfnRip_IF_KcCalls[EPMS_FN_PCLswapHdr]       = (int(*)())PMS_PCLswapHdr;
  ...
  apfnRip_IF_KcCalls[EPMS_FN_HWA1_GetBuffer]      =   PMS_HWA1_GetBuffer;
  apfnRip_IF_KcCalls[EPMS_FN_HWA1_SubmitBuffer]   =   PMS_HWA1_SubmitBuffer;
  apfnRip_IF_KcCalls[EPMS_FN_HWA1_DiscardBuffer]  =   PMS_HWA1_DiscardBuffer;

  apfnRip_IF_KcCalls[EPMS_FN_HWA1_GetBands]       =   PMS_HWA1_GetBands;
  apfnRip_IF_KcCalls[EPMS_FN_HWA1_DiscardBands]   =   PMS_HWA1_DiscardBands;

#ifdef DEFAULT_PDL
  apfnRip_IF_KcCalls[EPMS_FN_TEC_SetLevel]        =   PMS_SetTECLevel;
#endif
