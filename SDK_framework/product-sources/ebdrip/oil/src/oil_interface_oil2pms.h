...
#define PMS_CancelPrintedPage     (int)(*(*g_apfn_pms_calls)[EPMS_FN_CancelPrintedPage])
...
#define PMS_PCL5ResourceStart     (int)(*(*g_apfn_pms_calls)[EPMS_FN_PCL5ResourceStart])
#define PMS_PCL5ResourceFinish    (int)(*(*g_apfn_pms_calls)[EPMS_FN_PCL5ResourceFinish])
#define PMS_PCL5ResourceError     (int)(*(*g_apfn_pms_calls)[EPMS_FN_PCL5ResourceError])
#define PMS_PCL5ResourceTransfer  (int)(*(*g_apfn_pms_calls)[EPMS_FN_PCL5ResourceTransfer])
...
#define  PMS_HWA1_GetBuffer             (int)(*(*g_apfn_pms_calls)[EPMS_FN_HWA1_GetBuffer])
#define  PMS_HWA1_SubmitBuffer          (int)(*(*g_apfn_pms_calls)[EPMS_FN_HWA1_SubmitBuffer])
#define  PMS_HWA1_DiscardBuffer         (int)(*(*g_apfn_pms_calls)[EPMS_FN_HWA1_DiscardBuffer])
#define  PMS_HWA1_GetBands              (int)(*(*g_apfn_pms_calls)[EPMS_FN_HWA1_GetBands])
#define  PMS_HWA1_DiscardBands          (int)(*(*g_apfn_pms_calls)[EPMS_FN_HWA1_DiscardBands])

#define  PMS_SetTECLevel                (int)(*(*g_apfn_pms_calls)[EPMS_FN_TEC_SetLevel])
